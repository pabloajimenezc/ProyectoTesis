...
PrevZCX_imperix_M2C_NN_contro_T imperix_M2C_NN_control__PrevZCX;
...
void microKernel14549314565255529218(int32_T K, const real32_T *A, int32_T LDA,
...
void microKernel12941087102713228357(int32_T K, const real32_T *A, int32_T LDA,
  const real32_T *B, real32_T *C)
{
  int32_T idxA;
  int32_T idxB;
...
void macroKernel12870344225168056569(int32_T M, int32_T K, int32_T N, const
  ...
  LDC)
{
  ...
  while (j < N) {
    ...
    idxA = 0;
    while (i <= M - 7) {
      microKernel12941087102713228357(K, &A[idxA], LDA, &B[idxB], &C[idxC]);
      idxA += 7;
      idxC += 7;
      i += 7;
    }
    ...
    while (i <= M - 1) {
      microKernel14549314565255529218(K, &A[idxA], LDA, &B[idxB], &C[idxC]);
      idxA++;
      idxC++;
      i++;
    }
...
void matrixMultiply12870344225168056569(int32_T M, int32_T K, int32_T N, int32_T
  ...
  for (j1 = 0; j1 < N; j1 += blockSizeN) {
    ...
    for (k0 = 1; k0 <= k0_ub + 1; k0++) {
      ...
      for (i0 = 1; i0 <= i0_ub + 1; i0++) {
        ...
        macroKernel12870344225168056569(tmp, K2, N2, &A[i + M * k], M, &B[k + K *
          j1], K, &C[i + M * j1], M);
      }
    }
  }
...
// Function for MATLAB Function: '<S148>/MLFB'
static void imperix_M2C_NN_control__predict(const real32_T inputsT_0_f1[14],
  real32_T outputs_0_f1[3])
{
  int32_T channelIdx;
  ...
  matrixMultiply12870344225168056569(70, 14, 1, 64, 64, 64, &(&tmp[0])[0],
    &inputsT_0_f1[0], &X[0]);
  ...
  matrixMultiply12870344225168056569(3, 70, 1, 64, 64, 64, &(&tmp_0[0])[0], &X[0],
    &outputs_0_f1[0]);
...
static void imperix_M2C_NN_SystemCore_setup(dsp_simulink_MovingRMS_imperi_T *obj)
{
  ...
  // Start for MATLABSystem: '<S1>/Moving RMS1' incorporates:
...
void imperix_M2C_NN_control_2024b_step0(void) // Sample time: [8.33333e-05s, 0.0s] 
{
  real_T y[6];
  real_T y_0[6];
  ...
  //   Sample time: [8.3333333333333331E-5s, 0.0s] to Sample time: [0.00016666666666666666s, 0.0s]  
  (imperix_M2C_NN_control_2024b_M->Timing.RateInteraction.TID0_1)++;
  if ((imperix_M2C_NN_control_2024b_M->Timing.RateInteraction.TID0_1) > 1) {
    imperix_M2C_NN_control_2024b_M->Timing.RateInteraction.TID0_1 = 0;
  }

  // RateTransition generated from: '<S29>/Subsystem' incorporates:
  //   RateTransition generated from: '<S1>/Circulating Current Control MPC'

  tmp = (imperix_M2C_NN_control_2024b_M->Timing.RateInteraction.TID0_1 == 1);
  if (tmp) {
    // RateTransition generated from: '<S29>/Subsystem'
    for (i = 0; i < 14; i++) {
      imperix_M2C_NN_control_2024b_B.TmpRTBAtSubsystemInport1[i] =
        imperix_M2C_NN_control_2024b_DW.TmpRTBAtSubsystemInport1_Buffer[i];
    }
  }

  // End of RateTransition generated from: '<S29>/Subsystem'

  // DiscretePulseGenerator: '<S29>/Pulse Generator'
  rtb_PulseGenerator = (imperix_M2C_NN_control_2024b_DW.clockTickCounter <
                        imperix_M2C_NN_control_2024b_P.PulseGenerator_Duty) &&
    (imperix_M2C_NN_control_2024b_DW.clockTickCounter >= 0) ?
    imperix_M2C_NN_control_2024b_P.PulseGenerator_Amp : 0.0;
  if (imperix_M2C_NN_control_2024b_DW.clockTickCounter >=
      imperix_M2C_NN_control_2024b_P.PulseGenerator_Period - 1.0) {
    imperix_M2C_NN_control_2024b_DW.clockTickCounter = 0;
  } else {
    imperix_M2C_NN_control_2024b_DW.clockTickCounter++;
  }
  ...
  zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,
                     &imperix_M2C_NN_control__PrevZCX.Subsystem_Trig_ZCE,
                     (rtb_PulseGenerator));
  if (zcEvent != NO_ZCEVENT) {
    // MATLAB Function: '<S148>/MLFB' incorporates:
    //   RateTransition generated from: '<S29>/Subsystem'

    imperix_M2C_NN_control__predict
      (imperix_M2C_NN_control_2024b_B.TmpRTBAtSubsystemInport1, tmp_0);
    imperix_M2C_NN_control_2024b_B.out_1_predict[0] = tmp_0[0];
    imperix_M2C_NN_control_2024b_B.out_1_predict[1] = tmp_0[1];
    imperix_M2C_NN_control_2024b_B.out_1_predict[2] = tmp_0[2];
  }
  ...
  rtb_Gain1_n[0] = imperix_M2C_NN_control_2024b_P.Ymax[0] *
    imperix_M2C_NN_control_2024b_B.out_1_predict[0];
  rtb_Gain1_n[1] = imperix_M2C_NN_control_2024b_P.Ymax[1] *
    imperix_M2C_NN_control_2024b_B.out_1_predict[1];
  rtb_Gain1_n[2] = imperix_M2C_NN_control_2024b_P.Ymax[2] *
    imperix_M2C_NN_control_2024b_B.out_1_predict[2];
  ...
  for (i = 0; i < 2; i++) {
    rtb_PulseGenerator = rtb_Gain1_n[i];
    for (b_k = 0; b_k < 6; b_k++) {
      imperix_M2C_NN_control_2024b_B.Gain2[b_k] +=
        imperix_M2C_NN_control_2024b_P.N[6 * i + b_k] * rtb_PulseGenerator;
    }
  }
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_p = static_cast<real32_T>
    (imperix_M2C_NN_control_2024b_B.Gain2[0]);

  // S-Function (PROBE): '<S263>/S-Function'
  iar_zref = imperix_M2C_NN_control_2024b_B.DataTypeConversion_p;
  ...
  ibr_zref = imperix_M2C_NN_control_2024b_B.DataTypeConversion_k;

  // MATLABSystem: '<S1>/Moving RMS1'
  if (imperix_M2C_NN_control_2024b_DW.obj_i.TunablePropsChanged) {
    imperix_M2C_NN_control_2024b_DW.obj_i.TunablePropsChanged = false;
  }

  rtb_PulseGenerator = imperix_M2C_NN_control_2024b_DW.obj_i.pCumRevIndex;
  csum = imperix_M2C_NN_control_2024b_DW.obj_i.pCumSum;
  modValueRev = imperix_M2C_NN_control_2024b_DW.obj_i.pModValueRev;
  i = 1;
  z = 0.0;
  for (b_k = 0; b_k < 6; b_k++) {
    y_1 = std::abs(imperix_M2C_NN_control_2024b_B.Gain2[b_k]);
    y_0[b_k] = y_1 * y_1;
    y[b_k] = 0.0;
  }
  ...
  for (b_k = 0; b_k < 6; b_k++) {
    ...
    csum += y_1;
    if (modValueRev == 0.0) {
      z = imperix_M2C_NN_control_2024b_DW.obj_i.pCumSumRev[static_cast<int32_T>
        (rtb_PulseGenerator) - 1] + csum;
    }

    imperix_M2C_NN_control_2024b_DW.obj_i.pCumSumRev[static_cast<int32_T>
      (rtb_PulseGenerator) - 1] = y_1;
    if (rtb_PulseGenerator != 39.0) {
      rtb_PulseGenerator++;
    } else {
      rtb_PulseGenerator = 1.0;
      csum = 0.0;
      for (k = 37; k >= 0; k--) {
        imperix_M2C_NN_control_2024b_DW.obj_i.pCumSumRev[k] +=
          imperix_M2C_NN_control_2024b_DW.obj_i.pCumSumRev[k + 1];
      }
    }
  ...
  imperix_M2C_NN_control_2024b_DW.obj_i.pCumSum = csum;
  imperix_M2C_NN_control_2024b_DW.obj_i.pCumRevIndex = rtb_PulseGenerator;
  imperix_M2C_NN_control_2024b_DW.obj_i.pModValueRev = modValueRev;
  for (b_k = 0; b_k < 6; b_k++) {
    y[b_k] = std::sqrt(y[b_k]);
  }

  // S-Function (sdspstatfcns): '<S1>/Mean2' incorporates:
  //   MATLABSystem: '<S1>/Moving RMS1'

  rtb_PulseGenerator = y[0];
  for (i = 4; i >= 0; i--) {
    rtb_PulseGenerator += y[5 - i];
  }

  // RateTransition generated from: '<S1>/Circulating Current Control MPC'
  if (tmp) {
    // RateTransition generated from: '<S1>/Divide' incorporates:
    //   S-Function (sdspstatfcns): '<S1>/Mean2'

    imperix_M2C_NN_control_2024b_DW.TmpRTBAtDivideInport1_Buffer =
      rtb_PulseGenerator / 6.0;

    // RateTransition generated from: '<S1>/Gain54' incorporates:
    //   Gain: '<S1>/Gain54'

    imperix_M2C_NN_control_2024b_DW.TmpRTBAtGain54Outport1_Buffer =
      imperix_M2C_NN_control_2024b_P.Gain54_Gain * rtb_Gain1_n[2];
  }
}

// Model step function for TID1
void imperix_M2C_NN_control_2024b_step1(void) // Sample time: [0.000166667s, 0.0s] 
{
  real_T rtb_VectorConcatenate[14];
  real_T tmp_1[8];
  real_T rtb_Gain3_jb[6];
  real_T rtb_Gain9[6];
  real_T rtb_Square1[6];
  real_T rtb_TmpSignalConversionAtSFun_h[6];
  real_T y[6];
  real_T rtb_Gain1[5];
  real_T Linv[4];
  real_T Linv_0[4];
  real_T rtb_TmpSignalConversionAtSFu_ls[4];
  real_T tmp_2[4];
  ...
  real_T rtb_Gain31_idx_0;
  real_T rtb_Gain31_idx_1;
  real_T rtb_Gain3_a_0;
  real_T rtb_Gain3_a_idx_0;
  real_T rtb_Gain3_a_idx_1;
  real_T rtb_Gain3_m_idx_2;
  real_T rtb_Pm;
  real_T rtb_Product4;
  ...
  (imperix_M2C_NN_control_2024b_M->Timing.RateInteraction.TID1_2)++;
  if ((imperix_M2C_NN_control_2024b_M->Timing.RateInteraction.TID1_2) > 5) {
    imperix_M2C_NN_control_2024b_M->Timing.RateInteraction.TID1_2 = 0;
  }

  // S-Function (ADC): '<S131>/ADC'
  imperix_M2C_NN_control_2024b_B.ADC = (float)(*ix_raw_adc_ptr_0_0) *
    0.00045776F + 0.0F;
  ...
  imperix_M2C_NN_control_2024b_B.ADC_f = (float)(*ix_raw_adc_ptr_2_0) *
    0.00045776F + 0.0F;
  ...
  imperix_M2C_NN_control_2024b_B.ADC_b = (float)(*ix_raw_adc_ptr_4_0) *
    0.00045776F + 0.0F;
  ...
  rtb_Gain9[0] = imperix_M2C_NN_control_2024b_B.ADC;
  rtb_Gain9[1] = imperix_M2C_NN_control_2024b_B.ADC_p;
  rtb_Gain9[2] = imperix_M2C_NN_control_2024b_B.ADC_f;
  rtb_Gain9[3] = imperix_M2C_NN_control_2024b_B.ADC_o;
  rtb_Gain9[4] = imperix_M2C_NN_control_2024b_B.ADC_b;
  rtb_Gain9[5] = imperix_M2C_NN_control_2024b_B.ADC_i;
  ...
  for (i = 0; i < 6; i++) {
    rtb_Pm = rtb_Gain9[i];
    for (modIndex = 0; modIndex < 5; modIndex++) {
      rtb_Gain1[modIndex] += imperix_M2C_NN_control_2024b_P.A[5 * i + modIndex] *
        rtb_Pm;
    }
  }
  ...
  // Gain: '<S353>/Gain3'
  rtb_Gain3_a_idx_0 = 0.0;
  rtb_Gain3_a_idx_1 = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_Pm = rtb_Gain1[i + 2];
    rtb_Gain3_a_idx_0 += imperix_M2C_NN_control_2024b_P.Gain3_Gain[3 * i] *
      rtb_Pm;
    rtb_Gain3_a_idx_1 += imperix_M2C_NN_control_2024b_P.Gain3_Gain[3 * i + 1] *
      rtb_Pm;
  }

  // End of Gain: '<S353>/Gain3'

  // Gain: '<S353>/Gain1'
  rtb_Gain3_a_idx_0 *= imperix_M2C_NN_control_2024b_P.Gain1_Gain;
  rtb_Gain3_a_idx_1 *= imperix_M2C_NN_control_2024b_P.Gain1_Gain;
  ...
  if (imperix_M2C_NN_control_2024b_DW.Initial_FirstOutputTime) {
    ...
    // InitialCondition: '<S141>/Initial'
    Initial = imperix_M2C_NN_control_2024b_P.IntegratorwithWrappedStateDis_g;
  } else {
    // Gain: '<S144>/Gain' incorporates:
    //   Gain: '<S144>/Gain1'

    Initial = imperix_M2C_NN_control_2024b_P.IntegratorwithWrappedStateDis_p -
    ...
    Initial = imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE - std::floor(1.0
      / Initial * (imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE -
                   imperix_M2C_NN_control_2024b_P.IntegratorwithWrappedStateDiscr))
      * Initial;
  }
  ...
  if ((imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE <
    ...
    imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE = Initial;
  }
  ...
  Mean_AccVal = std::sin(imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE);
  rtb_Gain3_m_idx_2 = std::cos(imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE);
  rtb_Fcn = rtb_Gain3_a_idx_0 * rtb_Gain3_m_idx_2 + rtb_Gain3_a_idx_1 *
    Mean_AccVal;

  // Fcn: '<S352>/Fcn1'
  rtb_Fcn1 = -rtb_Gain3_a_idx_0 * Mean_AccVal + rtb_Gain3_a_idx_1 *
    rtb_Gain3_m_idx_2;
  ...
  Initial = imperix_M2C_NN_control_2024b_P.prmt_EST[1] /
    imperix_M2C_NN_control_2024b_P.prmt_EST[0];
  imperix_M2C_NN_control_2024b_DW.psir0 = (Initial *
    imperix_M2C_NN_control_2024b_DW.psir0 + rtb_Fcn *
    imperix_M2C_NN_control_2024b_P.prmt_EST[2]) / (Initial + 1.0);
  if (imperix_M2C_NN_control_2024b_DW.psir0 == 0.0) {
    Initial = 0.0;
  } else {
    Initial = rtb_Fcn1 * imperix_M2C_NN_control_2024b_P.prmt_EST[2] /
      (imperix_M2C_NN_control_2024b_P.prmt_EST[1] *
       imperix_M2C_NN_control_2024b_DW.psir0);
  }

  Initial += imperix_M2C_NN_control_2024b_B.ADC_j;
  ...
  rtb_Gain3_a_idx_0 = imperix_M2C_NN_control_2024b_P.prmt_FC[0] / 1.5;
  rtb_Gain3_a_idx_0 *= imperix_M2C_NN_control_2024b_P.Gain8_Gain *
    imperix_M2C_NN_control_2024b_B.SFunction /
    imperix_M2C_NN_control_2024b_P.prmt_FC[3] * (rtb_Gain3_a_idx_0 + 1.0) /
    rtb_Gain3_a_idx_0 - imperix_M2C_NN_control_2024b_P.Gain8_Gain *
    imperix_M2C_NN_control_2024b_DW.psir0 /
    imperix_M2C_NN_control_2024b_P.prmt_FC[3];
  if (rtb_Gain3_a_idx_0 >= imperix_M2C_NN_control_2024b_P.prmt_FC[1]) {
    rtb_Gain3_a_idx_0 = imperix_M2C_NN_control_2024b_P.prmt_FC[1];
  } else if (rtb_Gain3_a_idx_0 <= -imperix_M2C_NN_control_2024b_P.prmt_FC[1]) {
    rtb_Gain3_a_idx_0 = -imperix_M2C_NN_control_2024b_P.prmt_FC[1];
  }

  rtb_id_ref = static_cast<real_T>(imperix_M2C_NN_control_2024b_B.SFunction_f) *
    rtb_Gain3_a_idx_0;
  ...
  tmp = (imperix_M2C_NN_control_2024b_M->Timing.RateInteraction.TID1_2 == 1);
  if (tmp) {
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_il = static_cast<real32_T>
    (imperix_M2C_NN_control_2024b_P.Gain17_Gain * rtb_id_ref);

  // S-Function (PROBE): '<S163>/S-Function'
  imd_r = imperix_M2C_NN_control_2024b_B.DataTypeConversion_il;

  // S-Function (ADC): '<S119>/ADC'
  imperix_M2C_NN_control_2024b_B.ADC_d = (float)(*ix_raw_adc_ptr_6_0) *
    0.027466F + 0.0F;
  ...
  imperix_M2C_NN_control_2024b_B.ADC_b2 = (float)(*ix_raw_adc_ptr_1_1) *
    0.027466F + 0.0F;
  ...
  imperix_M2C_NN_control_2024b_B.ADC_f5 = (float)(*ix_raw_adc_ptr_3_1) *
    0.027466F + 0.0F;
  ...
  rtb_Gain3_jb[0] = imperix_M2C_NN_control_2024b_B.ADC_d;
  rtb_Gain3_jb[1] = imperix_M2C_NN_control_2024b_B.ADC_k;
  rtb_Gain3_jb[2] = imperix_M2C_NN_control_2024b_B.ADC_e;
  rtb_Gain3_jb[3] = imperix_M2C_NN_control_2024b_B.ADC_b2;
  rtb_Gain3_jb[4] = imperix_M2C_NN_control_2024b_B.ADC_k2;
  rtb_Gain3_jb[5] = imperix_M2C_NN_control_2024b_B.ADC_f5;

  // Sum: '<S1>/Sum2'
  rtb_i_dc = -0.0;
  for (i = 0; i < 6; i++) {
    // Math: '<S1>/Square1'
    rtb_Gain31_idx_0 = rtb_Gain3_jb[i];
    rtb_Gain3_a_idx_0 = rtb_Gain31_idx_0 * rtb_Gain31_idx_0;
    rtb_Square1[i] = rtb_Gain3_a_idx_0;

    // Sum: '<S1>/Sum2'
    rtb_i_dc += rtb_Gain3_a_idx_0;
  }
  ...
  imperix_M2C_NN_control_2024b_DW.ud = ((rtb_id_ref -
  ...
  imperix_M2C_NN_control_2024b_DW.uq = ((rtb_Product4 -
    ...
    imperix_M2C_NN_control_2024b_DW.aq) *
    imperix_M2C_NN_control_2024b_P.prmt_OCC[0];
  rtb_Gain3_a_idx_0 = std::sqrt(imperix_M2C_NN_control_2024b_DW.ud *
    imperix_M2C_NN_control_2024b_DW.ud + imperix_M2C_NN_control_2024b_DW.uq *
    imperix_M2C_NN_control_2024b_DW.uq);
  rtb_Gain3_a_idx_1 = rt_atan2d_snf(imperix_M2C_NN_control_2024b_DW.uq,
    imperix_M2C_NN_control_2024b_DW.ud);
  if (rtb_Gain3_a_idx_0 >= imperix_M2C_NN_control_2024b_P.prmt_OCC[2]) {
    rtb_Gain3_a_idx_0 = imperix_M2C_NN_control_2024b_P.prmt_OCC[2];
  } else if (rtb_Gain3_a_idx_0 <= -imperix_M2C_NN_control_2024b_P.prmt_OCC[2]) {
    rtb_Gain3_a_idx_0 = -imperix_M2C_NN_control_2024b_P.prmt_OCC[2];
  }

  rtb_Gain31_idx_0 = Initial * imperix_M2C_NN_control_2024b_P.prmt_OCC[4];
  rtb_vd_ref = (rtb_Gain3_a_idx_0 * std::cos(rtb_Gain3_a_idx_1) -
                rtb_Gain31_idx_0 * rtb_Product4) * static_cast<real_T>
    (imperix_M2C_NN_control_2024b_B.SFunction_f);
  rtb_vq_ref = (rtb_Gain31_idx_0 * rtb_id_ref + rtb_Gain3_a_idx_0 * std::sin
                (rtb_Gain3_a_idx_1)) * static_cast<real_T>
    (imperix_M2C_NN_control_2024b_B.SFunction_f);
  ...
  rtb_Gain31_idx_0 = rtb_Gain3_m_idx_2 * rtb_vd_ref + -Mean_AccVal * rtb_vq_ref;
  rtb_Gain31_idx_1 = Mean_AccVal * rtb_vd_ref + rtb_Gain3_m_idx_2 * rtb_vq_ref;

  // SignalConversion generated from: '<S18>/Gain3' incorporates:
  //   Constant: '<S1>/Constant1'

  rtb_Gain31_0[0] = rtb_Gain31_idx_0;
  rtb_Gain31_0[1] = rtb_Gain31_idx_1;
  rtb_Gain31_0[2] = imperix_M2C_NN_control_2024b_P.Constant1_Value;
  ...
  for (i = 0; i < 3; i++) {
    ...
    rtb_Gain3_a_idx_0 += imperix_M2C_NN_control_2024b_P.Gain3_Gain_n[3 * i] *
      rtb_Pm;
    rtb_Gain3_a_idx_1 += imperix_M2C_NN_control_2024b_P.Gain3_Gain_n[3 * i + 1] *
      rtb_Pm;
    rtb_Gain20_idx_0 += imperix_M2C_NN_control_2024b_P.Gain3_Gain_n[3 * i + 2] *
      rtb_Pm;
  }
  ...
  // Gain: '<S1>/Gain'
  rtb_Gain3_a_0 = imperix_M2C_NN_control_2024b_P.Gain_Gain * rtb_Gain3_a_idx_0;
  rtb_Gain3_a_idx_0 = rtb_Gain3_a_0;

  // SignalConversion generated from: '<S31>/ SFunction ' incorporates:
  //   MATLAB Function: '<S1>/P'

  rtb_TmpSignalConversionAtSFun_h[3] = rtb_Gain3_a_0;

  // Gain: '<S1>/Gain'
  rtb_Gain3_a_0 = imperix_M2C_NN_control_2024b_P.Gain_Gain * rtb_Gain3_a_idx_1;
  rtb_Gain3_a_idx_1 = rtb_Gain3_a_0;

  // SignalConversion generated from: '<S31>/ SFunction ' incorporates:
  //   MATLAB Function: '<S1>/P'

  rtb_TmpSignalConversionAtSFun_h[4] = rtb_Gain3_a_0;

  // Gain: '<S1>/Gain'
  rtb_Gain3_a_0 = imperix_M2C_NN_control_2024b_P.Gain_Gain * rtb_Gain20_idx_0;
  ...
  rtb_TmpSignalConversionAtSFu_kl[2] = rtb_Gain3_a_0;
  rtb_TmpSignalConversionAtSFun_1 = 0.0;
  rtb_TmpSignalConversionAtSFun_0 = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_Pm = rtb_Gain31_0[i];
    modIndex = i << 1;
    Tab = imperix_M2C_NN_control_2024b_P.Tab[modIndex];
    rtb_Gain20_idx_0 += Tab * rtb_Pm;
    Tab_0 = imperix_M2C_NN_control_2024b_P.Tab[modIndex + 1];
    rtb_Gain20_idx_1 += Tab_0 * rtb_Pm;
    rtb_Pm = rtb_TmpSignalConversionAtSFu_kl[i];
    rtb_TmpSignalConversionAtSFun_1 += Tab * rtb_Pm;
    rtb_TmpSignalConversionAtSFun_0 += Tab_0 * rtb_Pm;
  }

  rtb_Pm = (rtb_Gain20_idx_0 * rtb_TmpSignalConversionAtSFun_1 +
            rtb_Gain20_idx_1 * rtb_TmpSignalConversionAtSFun_0) * 1.5;
  ...
  rtb_Gain20_idx_1 = 2.0 * imperix_M2C_NN_control_2024b_P.n;
  ...
  imperix_M2C_NN_control_2024b_DW.u = ((6.0 * imperix_M2C_NN_control_2024b_P.C /
    rtb_Gain20_idx_1 * (imperix_M2C_NN_control_2024b_P.Constant2_Value *
                        imperix_M2C_NN_control_2024b_P.Constant2_Value) -
    imperix_M2C_NN_control_2024b_P.C / rtb_Gain20_idx_1 * rtb_i_dc) -
    imperix_M2C_NN_control_2024b_DW.a) * rtb_Gain20_idx_0;
  ...
  rtb_i_dc = (imperix_M2C_NN_control_2024b_DW.u -
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_ki = static_cast<real32_T>
    (((std::cos(imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE -
                2.0943951023931953) * rtb_Gain1[3] + rtb_Gain1[2] *
       rtb_Gain3_m_idx_2) + std::cos
  ...
  imd = imperix_M2C_NN_control_2024b_B.DataTypeConversion_ki;
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_c = static_cast<real32_T>(((
    -rtb_Gain1[2] * Mean_AccVal - std::sin
    (imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE - 2.0943951023931953) *
    rtb_Gain1[3]) - std::sin(imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE +
    2.0943951023931953) * rtb_Gain1[4]) * 0.66666666666666663);
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_pe =
    imperix_M2C_NN_control_2024b_B.ADC;

  // S-Function (PROBE): '<S175>/S-Function'
  iar = imperix_M2C_NN_control_2024b_B.DataTypeConversion_pe;
  ...
  imperix_M2C_NN_control_2024b_DW.u_n = ((rtb_i_dc - rtb_Gain1[0]) -
    imperix_M2C_NN_control_2024b_DW.a_d) *
    imperix_M2C_NN_control_2024b_P.prmt_ICC[0];
  ...
  rtb_i_dc = (1.5 * imperix_M2C_NN_control_2024b_P.Constant14_Value +
              imperix_M2C_NN_control_2024b_DW.u_n) *
    imperix_M2C_NN_control_2024b_B.SFunction_i;
  ...
  rtb_vd_ref = rtb_Gain1[0] / 3.0;
  rtb_Pm = 0.1 * rtb_Gain1[4];
  rtb_vq_ref = 0.1 * rtb_Gain1[3];
  rtb_Gain20_idx_0 = 0.4 * rtb_Gain1[2];
  imperix_M2C_NN_control_2024b_B.ib[0] = ((rtb_vd_ref - rtb_Gain20_idx_0) +
    rtb_vq_ref) + rtb_Pm;
  rtb_Gain20_idx_1 = 0.1 * rtb_Gain1[2];
  rtb_vd_ref += rtb_Gain20_idx_1;
  rtb_TmpSignalConversionAtSFun_1 = 0.4 * rtb_Gain1[3];
  imperix_M2C_NN_control_2024b_B.ib[1] = (rtb_vd_ref -
    rtb_TmpSignalConversionAtSFun_1) + rtb_Pm;
  rtb_TmpSignalConversionAtSFun_0 = 0.4 * rtb_Gain1[4];
  imperix_M2C_NN_control_2024b_B.ib[2] = (rtb_vd_ref + rtb_vq_ref) -
    rtb_TmpSignalConversionAtSFun_0;
  rtb_vd_ref = -rtb_Gain1[0] / 3.0;
  imperix_M2C_NN_control_2024b_B.ib[3] = ((rtb_vd_ref - rtb_Gain20_idx_0) +
    rtb_vq_ref) + rtb_Pm;
  rtb_vd_ref += rtb_Gain20_idx_1;
  imperix_M2C_NN_control_2024b_B.ib[4] = (rtb_vd_ref -
    rtb_TmpSignalConversionAtSFun_1) + rtb_Pm;
  imperix_M2C_NN_control_2024b_B.ib[5] = (rtb_vd_ref + rtb_vq_ref) -
    rtb_TmpSignalConversionAtSFun_0;

  // MATLABSystem: '<S1>/Moving RMS2'
  if (imperix_M2C_NN_control_2024b_DW.obj.TunablePropsChanged) {
    imperix_M2C_NN_control_2024b_DW.obj.TunablePropsChanged = false;
  }

  rtb_vd_ref = imperix_M2C_NN_control_2024b_DW.obj.pCumRevIndex;
  rtb_Pm = imperix_M2C_NN_control_2024b_DW.obj.pCumSum;
  rtb_vq_ref = imperix_M2C_NN_control_2024b_DW.obj.pModValueRev;
  modIndex = 1;
  rtb_Gain20_idx_0 = 0.0;
  for (i = 0; i < 6; i++) {
    rtb_Gain20_idx_1 = std::abs(imperix_M2C_NN_control_2024b_B.ib[i]);
    rtb_TmpSignalConversionAtSFun_h[i] = rtb_Gain20_idx_1 * rtb_Gain20_idx_1;
    y[i] = 0.0;
  }

  for (c_index = 0; c_index < 6; c_index++) {
    rtb_Gain20_idx_1 = rtb_TmpSignalConversionAtSFun_h[c_index];
    rtb_Pm += rtb_Gain20_idx_1;
    if (rtb_vq_ref == 0.0) {
      rtb_Gain20_idx_0 = imperix_M2C_NN_control_2024b_DW.obj.pCumSumRev[
        static_cast<int32_T>(rtb_vd_ref) - 1] + rtb_Pm;
    }

    imperix_M2C_NN_control_2024b_DW.obj.pCumSumRev[static_cast<int32_T>
      (rtb_vd_ref) - 1] = rtb_Gain20_idx_1;
    if (rtb_vd_ref != 39.0) {
      rtb_vd_ref++;
    } else {
      rtb_vd_ref = 1.0;
      rtb_Pm = 0.0;
      for (i = 37; i >= 0; i--) {
        imperix_M2C_NN_control_2024b_DW.obj.pCumSumRev[i] +=
          imperix_M2C_NN_control_2024b_DW.obj.pCumSumRev[i + 1];
      }
    }

    if (rtb_vq_ref == 0.0) {
      y[modIndex - 1] = rtb_Gain20_idx_0 / 40.0;
  ...
  imperix_M2C_NN_control_2024b_DW.obj.pCumSum = rtb_Pm;
  imperix_M2C_NN_control_2024b_DW.obj.pCumRevIndex = rtb_vd_ref;
  imperix_M2C_NN_control_2024b_DW.obj.pModValueRev = rtb_vq_ref;
  for (i = 0; i < 6; i++) {
    y[i] = std::sqrt(y[i]);
  }
  ...
  //   RateTransition generated from: '<S1>/Divide'

  if ((rtb_vd_ref == 0.0) || std::isnan(rtb_vd_ref)) {
    rtb_vd_ref = imperix_M2C_NN_control_2024b_DW.TmpRTBAtDivideInport1_Buffer /
      (rtb_vd_ref + 0.001);
  } else {
    rtb_vd_ref = imperix_M2C_NN_control_2024b_DW.TmpRTBAtDivideInport1_Buffer /
      rtb_vd_ref;
  ...
  rtb_vd_ref = (imperix_M2C_NN_control_2024b_B.SFunction_n +
                0.0011111074070546719) * 2.0;
  rtb_TmpSignalConversionAtSFu_ls[0] = rtb_vd_ref;
  rtb_Pm = imperix_M2C_NN_control_2024b_B.SFunction_n * 0.0 * 2.0;
  rtb_TmpSignalConversionAtSFu_ls[1] = rtb_Pm;
  rtb_TmpSignalConversionAtSFu_ls[2] = rtb_Pm;
  rtb_TmpSignalConversionAtSFu_ls[3] = rtb_vd_ref;
  modIndex = 0;
  c_index = 0;
  exitg1 = false;
  while ((!exitg1) && (c_index < 2)) {
    idxAjj = (c_index << 1) + c_index;
    rtb_vd_ref = 0.0;
    if (c_index >= 1) {
      for (i = 0; i < 1; i++) {
        rtb_vd_ref += rtb_TmpSignalConversionAtSFu_ls[1] *
          rtb_TmpSignalConversionAtSFu_ls[1];
      }
    }

    rtb_vd_ref = rtb_TmpSignalConversionAtSFu_ls[idxAjj] - rtb_vd_ref;
    if (rtb_vd_ref > 0.0) {
      rtb_vd_ref = std::sqrt(rtb_vd_ref);
      rtb_TmpSignalConversionAtSFu_ls[idxAjj] = rtb_vd_ref;
      if (c_index + 1 < 2) {
        rtb_vd_ref = 1.0 / rtb_vd_ref;
        for (i = idxAjj + 2; i <= idxAjj + 2; i++) {
          rtb_TmpSignalConversionAtSFu_ls[i - 1] *= rtb_vd_ref;
        }
      }
  ...
  if (modIndex == 0) {
    rtb_TmpSignalConversionAtSFu_ls[2] = 0.0;
  }
  ...
  Linv[2] = 0.0;
  Linv[3] = 1.0;
  imperix_M2C_NN_control_trisolve(rtb_TmpSignalConversionAtSFu_ls, Linv);
  iA1[0] = false;
  iA1[1] = false;
  iA1[2] = false;
  iA1[3] = false;
  ...
  for (i = 0; i < 6; i++) {
    rtb_Pm = rtb_Gain9[i];
    for (modIndex = 0; modIndex < 6; modIndex++) {
      y[modIndex] += imperix_M2C_NN_control_2024b_P.T[6 * i + modIndex] * rtb_Pm;
    }
  }
  ...
  rtb_vd_ref = (0.99999666667222276 * y[4] + 0.0 * y[5]) -
    imperix_M2C_NN_control_2024b_DW.ialbet_delr[0];
  rtb_Pm = (0.0 * y[4] + 0.99999666667222276 * y[5]) -
    imperix_M2C_NN_control_2024b_DW.ialbet_delr[1];
  for (i = 0; i < 2; i++) {
    modIndex = i << 1;
    rtb_vq_ref = Linv[modIndex + 1];
    rtb_Gain20_idx_0 = Linv[modIndex];
    Linv_0[modIndex] = rtb_vq_ref * Linv[1] + rtb_Gain20_idx_0 * Linv[0];
    Linv_0[modIndex + 1] = rtb_vq_ref * Linv[3] + rtb_Gain20_idx_0 * Linv[2];
    rtb_vq_ref = imperix_M2C_NN_control_2024b_DW.ialbet_delr[i];
    tmp_0[i] = ((b[i + 2] * rtb_Pm + b[i] * rtb_vd_ref) - ((rtb_vq_ref -
      rtb_vq_ref) / 0.00016666666666666666 * -0.005 - 0.0001 * rtb_vq_ref) *
                imperix_M2C_NN_control_2024b_B.SFunction_n) * 2.0;
  }

  for (i = 0; i < 8; i++) {
    tmp_1[i] = -imperix_M2C_NN_control_2024b_P.A_cc[i];
  }

  tmp_2[0] = -imperix_M2C_NN_control_2024b_P.b_cc[0];
  tmp_2[1] = -imperix_M2C_NN_control_2024b_P.b_cc[1];
  tmp_2[2] = -imperix_M2C_NN_control_2024b_P.b_cc[2];
  tmp_2[3] = -imperix_M2C_NN_control_2024b_P.b_cc[3];
  imperix_M2C_NN_control_2_qpkwik(Linv, Linv_0, tmp_0, tmp_1, tmp_2, iA1, 200,
    1.0E-6, is_dq, rtb_TmpSignalConversionAtSFu_ls, &i);
  ...
  //   RateTransition generated from: '<S1>/Gain54'

  y[0] = imperix_M2C_NN_control_2024b_DW.TmpRTBAtGain54Outport1_Buffer;
  y[1] = rtb_i_dc;
  y[2] = rtb_Gain31_idx_0;
  y[4] = imperix_M2C_NN_control_2024b_B.SFunction_p * is_dq[0];
  y[3] = rtb_Gain31_idx_1;
  y[5] = imperix_M2C_NN_control_2024b_B.SFunction_p * is_dq[1];
  ...
  for (i = 0; i < 6; i++) {
    rtb_Pm = y[i];
    for (modIndex = 0; modIndex < 6; modIndex++) {
      rtb_Gain9[modIndex] += imperix_M2C_NN_control_2024b_DW.Tinv[6 * i +
        modIndex] * rtb_Pm;
    }
  }

  rtb_TmpSignalConversionAtSFun_h[0] = 4.0 * rtb_Gain9[0] /
    (imperix_M2C_NN_control_2024b_B.ADC_d + 0.001);
  rtb_TmpSignalConversionAtSFun_h[1] = 4.0 * rtb_Gain9[1] /
    (imperix_M2C_NN_control_2024b_B.ADC_k + 0.001);
  rtb_TmpSignalConversionAtSFun_h[2] = 4.0 * rtb_Gain9[2] /
    (imperix_M2C_NN_control_2024b_B.ADC_e + 0.001);
  rtb_TmpSignalConversionAtSFun_h[3] = 4.0 * rtb_Gain9[3] /
    (imperix_M2C_NN_control_2024b_B.ADC_b2 + 0.001);
  rtb_TmpSignalConversionAtSFun_h[4] = 4.0 * rtb_Gain9[4] /
    (imperix_M2C_NN_control_2024b_B.ADC_k2 + 0.001);
  rtb_TmpSignalConversionAtSFun_h[5] = 4.0 * rtb_Gain9[5] /
    (imperix_M2C_NN_control_2024b_B.ADC_f5 + 0.001);
  rtb_TmpSignalConversionAtSFun_h[0] = std::fmax(std::fmin
    (rtb_TmpSignalConversionAtSFun_h[0], 4.0), 0.0);
  rtb_TmpSignalConversionAtSFun_h[3] = std::fmin(std::fmax
    (rtb_TmpSignalConversionAtSFun_h[3], -4.0), 0.0);
  rtb_TmpSignalConversionAtSFun_h[1] = std::fmax(std::fmin
    (rtb_TmpSignalConversionAtSFun_h[1], 4.0), 0.0);
  rtb_TmpSignalConversionAtSFun_h[4] = std::fmin(std::fmax
    (rtb_TmpSignalConversionAtSFun_h[4], -4.0), 0.0);
  rtb_TmpSignalConversionAtSFun_h[2] = std::fmax(std::fmin
    (rtb_TmpSignalConversionAtSFun_h[2], 4.0), 0.0);
  rtb_TmpSignalConversionAtSFun_h[5] = std::fmin(std::fmax
    (rtb_TmpSignalConversionAtSFun_h[5], -4.0), 0.0);
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_bp = static_cast<real32_T>
    ((rtb_id_ref * rtb_Gain3_m_idx_2 - rtb_Product4 * Mean_AccVal) *
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_f5 = static_cast<real32_T>
    ((rtb_id_ref * Mean_AccVal + rtb_Product4 * rtb_Gain3_m_idx_2) *
     imperix_M2C_NN_control_2024b_P.Gain3_Gain_a);
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_ci =
    imperix_M2C_NN_control_2024b_B.ADC_d;
  ...
  Mean_AccVal = imperix_M2C_NN_control_2024b_B.ADC_d;
  for (i = 4; i >= 0; i--) {
    Mean_AccVal += rtb_Gain3_jb[5 - i];
  }

  rtb_i_dc = Mean_AccVal / 6.0;

  // End of S-Function (sdspstatfcns): '<S1>/Mean'
  for (i = 0; i < 6; i++) {
    // Sum: '<S1>/Add1'
    Mean_AccVal = rtb_Gain3_jb[i] - rtb_i_dc;

    // Math: '<S1>/Square'
    rtb_Gain9[i] = Mean_AccVal * Mean_AccVal;
  }

  // S-Function (sdspstatfcns): '<S1>/Mean1'
  Mean_AccVal = rtb_Gain9[0];
  for (i = 4; i >= 0; i--) {
    Mean_AccVal += rtb_Gain9[5 - i];
  }
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_o0 = static_cast<real32_T>
    (std::sqrt(Mean_AccVal / 6.0) * imperix_M2C_NN_control_2024b_P.Gain25_Gain);
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_hb =
    imperix_M2C_NN_control_2024b_B.ADC_b2;
  ...
  imperix_M2C_NN_control_2024b_B.DataTypeConversion_gw =
    imperix_M2C_NN_control_2024b_B.ADC_f5;
  ...
  for (i = 0; i < 6; i++) {
    rtb_Gain3_jb[i] = rtb_Pm * rtb_Square1[i];

    // Gain: '<S1>/Gain9' incorporates:
    //   Math: '<S1>/Square3'

    rtb_Gain9[i] = imperix_M2C_NN_control_2024b_P.Gain9_Gain *
      rtb_TmpSignalConversionAtSFun_h[i];
  }

  // End of Gain: '<S1>/Gain6'

  // MATLAB Function: '<S1>/Tab0'
  Mean_AccVal = 0.0;
  rtb_Gain3_m_idx_2 = 0.0;
  for (i = 0; i < 3; i++) {
    rtb_Pm = rtb_Gain1[i + 2];
    Mean_AccVal += a[3 * i] * rtb_Pm;
    rtb_Gain3_m_idx_2 += a[3 * i + 1] * rtb_Pm;
  }
  ...
  rtb_Gain31_0[0] = Mean_AccVal;
  rtb_Gain31_0[1] = rtb_Gain3_m_idx_2;
  rtb_Gain31_0[2] = imperix_M2C_NN_control_2024b_P.Constant_Value;
  ...
  for (i = 0; i < 3; i++) {
    rtb_Pm = rtb_Gain31_0[i];
    rtb_Gain3_a_idx_0 += imperix_M2C_NN_control_2024b_P.Gain3_Gain_i[3 * i] *
      rtb_Pm;
    rtb_Gain3_a_idx_1 += imperix_M2C_NN_control_2024b_P.Gain3_Gain_i[3 * i + 1] *
      rtb_Pm;
  }

  // End of Gain: '<S145>/Gain3'

  // SignalConversion generated from: '<S146>/Gain3' incorporates:
  //   Constant: '<S29>/Constant1'
  //   Gain: '<S1>/Gain84'

  rtb_Gain31_0[0] = imperix_M2C_NN_control_2024b_P.Gain84_Gain *
    rtb_Gain31_idx_0;
  rtb_Gain31_0[1] = imperix_M2C_NN_control_2024b_P.Gain84_Gain *
    rtb_Gain31_idx_1;
  rtb_Gain31_0[2] = imperix_M2C_NN_control_2024b_P.Constant1_Value_o;
  ...
  for (i = 0; i < 3; i++) {
    rtb_Pm = rtb_Gain31_0[i];
    rtb_Fcn += imperix_M2C_NN_control_2024b_P.Gain3_Gain_j[3 * i] * rtb_Pm;
    Mean_AccVal += imperix_M2C_NN_control_2024b_P.Gain3_Gain_j[3 * i + 1] *
      rtb_Pm;
    rtb_Gain3_m_idx_2 += imperix_M2C_NN_control_2024b_P.Gain3_Gain_j[3 * i + 2] *
      rtb_Pm;
  }
  ...
  rtb_Pm = imperix_M2C_NN_control_2024b_P.C / 2.0;
  for (i = 0; i < 6; i++) {
    // Math: '<S29>/Square'
    rtb_Gain31_idx_0 = rtb_Gain3_jb[i];
    rtb_Gain3_jb[i] = rtb_Gain31_idx_0 * rtb_Gain31_idx_0 * rtb_Pm;
  }

  // End of Gain: '<S29>/Gain3'

  // S-Function (sdspstatfcns): '<S29>/Mean2'
  rtb_Fcn1 = rtb_Gain3_jb[0];
  for (i = 4; i >= 0; i--) {
    rtb_Fcn1 += rtb_Gain3_jb[5 - i];
  }

  rtb_i_dc = rtb_Fcn1 / 6.0;

  // End of S-Function (sdspstatfcns): '<S29>/Mean2'

  // SignalConversion generated from: '<S29>/Vector Concatenate'
  rtb_VectorConcatenate[0] = rtb_i_dc;

  // SignalConversion generated from: '<S29>/Vector Concatenate'
  rtb_VectorConcatenate[7] = rtb_Gain3_a_idx_0;
  rtb_VectorConcatenate[8] = rtb_Gain3_a_idx_1;

  // Sum: '<S29>/Sum2'
  rtb_Fcn -= rtb_Gain3_m_idx_2;

  // Sum: '<S29>/Sum3'
  Mean_AccVal -= rtb_Gain3_m_idx_2;

  // SignalConversion generated from: '<S29>/Vector Concatenate'
  rtb_VectorConcatenate[9] = rtb_Fcn;
  rtb_VectorConcatenate[10] = Mean_AccVal;
  ...
  // Sum: '<S29>/Sum'
  for (i = 0; i < 6; i++) {
    rtb_VectorConcatenate[i + 1] = rtb_Gain3_jb[i] - rtb_i_dc;
  }

  // End of Sum: '<S29>/Sum'

  // Product: '<S29>/Product'
  rtb_VectorConcatenate[11] = rtb_Gain3_a_idx_0 * rtb_Fcn;
  rtb_VectorConcatenate[12] = rtb_Gain3_a_idx_1 * Mean_AccVal;
  for (i = 0; i < 14; i++) {
    // RateTransition generated from: '<S29>/Subsystem' incorporates:
    ...
    imperix_M2C_NN_control_2024b_DW.TmpRTBAtSubsystemInport1_Buffer[i] =
      static_cast<real32_T>(1.0 / imperix_M2C_NN_control_2024b_P.Xmax[i] *
  ...
  // RateTransition generated from: '<S150>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3 =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S150>/generation'
  // S-Function (CB_PWM): '<S151>/PWM'
  ...
  // RateTransition generated from: '<S270>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_o =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S270>/generation'
  // S-Function (CB_PWM): '<S271>/PWM'
  ...
  // RateTransition generated from: '<S272>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_a =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S272>/generation'
  // S-Function (CB_PWM): '<S273>/PWM'
  ...
  // RateTransition generated from: '<S274>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_k =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S274>/generation'
  // S-Function (CB_PWM): '<S275>/PWM'
  ...
  // End of Outputs for SubSystem: '<S274>/generation'
  ...
  // RateTransition generated from: '<S276>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_g =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S276>/generation'
  // S-Function (CB_PWM): '<S277>/PWM'
  ...
  // End of Outputs for SubSystem: '<S276>/generation'
  ...
  // RateTransition generated from: '<S282>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ai =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S282>/generation'
  // S-Function (CB_PWM): '<S283>/PWM'
  ...
  // RateTransition generated from: '<S284>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_f =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S284>/generation'
  // S-Function (CB_PWM): '<S285>/PWM'
  ...
  // RateTransition generated from: '<S286>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_p =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S286>/generation'
  // S-Function (CB_PWM): '<S287>/PWM'
  ...
  // End of Outputs for SubSystem: '<S286>/generation'

  // DataTypeConversion: '<S281>/Data Type Conversion1' incorporates:
  //   DataTypeConversion: '<S278>/Data Type Conversion1'
  ...
  // RateTransition generated from: '<S288>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_d =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S288>/generation'
  // S-Function (CB_PWM): '<S289>/PWM'
  ...
  // End of Outputs for SubSystem: '<S288>/generation'

  // Gain: '<S93>/Gain1'
  rtb_i_dc = imperix_M2C_NN_control_2024b_P.Gain1_Gain_l * rtb_Gain9[3];
  ...
  // RateTransition generated from: '<S294>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ds =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S294>/generation'
  // S-Function (CB_PWM): '<S295>/PWM'
  ...
  // RateTransition generated from: '<S296>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_e =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S296>/generation'
  // S-Function (CB_PWM): '<S297>/PWM'
  ...
  // RateTransition generated from: '<S298>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_c =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S298>/generation'
  // S-Function (CB_PWM): '<S299>/PWM'
  ...
  // End of Outputs for SubSystem: '<S298>/generation'
  ...
  // RateTransition generated from: '<S300>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_e3 =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S300>/generation'
  // S-Function (CB_PWM): '<S301>/PWM'
  ...
  // End of Outputs for SubSystem: '<S300>/generation'

  // Gain: '<S94>/Gain3'
  rtb_i_dc = imperix_M2C_NN_control_2024b_P.Gain3_Gain_c * rtb_Gain9[4];
  ...
  // RateTransition generated from: '<S306>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ek =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S306>/generation'
  // S-Function (CB_PWM): '<S307>/PWM'
  ...
  // RateTransition generated from: '<S308>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_i =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S308>/generation'
  // S-Function (CB_PWM): '<S309>/PWM'
  ...
  // RateTransition generated from: '<S310>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_m =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S310>/generation'
  // S-Function (CB_PWM): '<S311>/PWM'
  ...
  // RateTransition generated from: '<S312>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_gd =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S312>/generation'
  // S-Function (CB_PWM): '<S313>/PWM'
  ...
  // Gain: '<S95>/Gain3'
  rtb_i_dc = imperix_M2C_NN_control_2024b_P.Gain3_Gain_f * rtb_Gain9[5];
  ...
  // RateTransition generated from: '<S318>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_b =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S318>/generation'
  // S-Function (CB_PWM): '<S319>/PWM'
  ...
  // RateTransition generated from: '<S320>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ev =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S320>/generation'
  // S-Function (CB_PWM): '<S321>/PWM'
  ...
  // RateTransition generated from: '<S322>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_dd =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S322>/generation'
  // S-Function (CB_PWM): '<S323>/PWM'
  ...
  // End of Outputs for SubSystem: '<S322>/generation'

  // DataTypeConversion: '<S317>/Data Type Conversion1' incorporates:
  //   DataTypeConversion: '<S314>/Data Type Conversion1'
  ...
  // RateTransition generated from: '<S324>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ms =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S324>/generation'
  // S-Function (CB_PWM): '<S325>/PWM'
  ...
  // End of Outputs for SubSystem: '<S324>/generation'
  ...
  // RateTransition generated from: '<S330>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ib =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S330>/generation'
  // S-Function (CB_PWM): '<S331>/PWM'
  ...
  // RateTransition generated from: '<S332>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_pj =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S332>/generation'
  // S-Function (CB_PWM): '<S333>/PWM'
  ...
  // RateTransition generated from: '<S334>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ddd =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S334>/generation'
  // S-Function (CB_PWM): '<S335>/PWM'
  ...
  // RateTransition generated from: '<S336>/generation' incorporates:
  //   Constant: '<S140>/clk_id'

  imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_fi =
    imperix_M2C_NN_control_2024b_P.clk_id_Value;

  // Outputs for Atomic SubSystem: '<S336>/generation'
  // S-Function (CB_PWM): '<S337>/PWM'
  ...
  imperix_M2C_NN_control_2024b_DW.Integrator_DSTATE +=
    imperix_M2C_NN_control_2024b_P.Integrator_gainval * Initial;
}

// Model step function for TID2
void imperix_M2C_NN_control_2024b_step2(void) // Sample time: [0.001s, 0.0s]
{
  real_T rtb_iq_ref;
...
void imperix_M2C_NN_control_2024b_initialize(void)
{
  ...
  (imperix_M2C_NN_control_2024b_M)->Timing.TaskCounters.cLimit[1] = 2;
  (imperix_M2C_NN_control_2024b_M)->Timing.TaskCounters.cLimit[2] = 12;

  {
    ...
    for (i = 0; i < 14; i++) {
      // Start for RateTransition generated from: '<S29>/Subsystem'
      imperix_M2C_NN_control_2024b_B.TmpRTBAtSubsystemInport1[i] =
        imperix_M2C_NN_control_2024b_P.TmpRTBAtSubsystemInport1_Initia;
    }
    ...
    imperix_M2C_NN_control_2024b_DW.obj_i.isInitialized = 0;
    imperix_M2C_NN_control_2024b_DW.obj_i.NumChannels = -1;
    imperix_M2C_NN_control_2024b_DW.obj_i.FrameLength = -1;
    imperix_M2C_NN_control_2024b_DW.obj_i.matlabCodegenIsDeleted = false;
    imperix_M2C_NN_SystemCore_setup(&imperix_M2C_NN_control_2024b_DW.obj_i);
    ...
    // Start for MATLABSystem: '<S1>/Moving RMS2'
    imperix_M2C_NN_control_2024b_DW.obj.isInitialized = 0;
    imperix_M2C_NN_control_2024b_DW.obj.NumChannels = -1;
    imperix_M2C_NN_control_2024b_DW.obj.FrameLength = -1;
    imperix_M2C_NN_control_2024b_DW.obj.matlabCodegenIsDeleted = false;
    imperix_M2C_NN_SystemCore_setup(&imperix_M2C_NN_control_2024b_DW.obj);
    ...
    // Start for S-Function (CB_PWM): '<S151>/PWM'
    ...
    // Start for S-Function (CB_PWM): '<S271>/PWM'
    ...
    // Start for S-Function (CB_PWM): '<S273>/PWM'
    ...
    // Start for Atomic SubSystem: '<S274>/generation'
    // Start for S-Function (CB_PWM): '<S275>/PWM'
    ...
    // End of Start for SubSystem: '<S274>/generation'

    // Start for Atomic SubSystem: '<S276>/generation'
    // Start for S-Function (CB_PWM): '<S277>/PWM'
    ...
    // End of Start for SubSystem: '<S276>/generation'

    // Start for Atomic SubSystem: '<S282>/generation'
    // Start for S-Function (CB_PWM): '<S283>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 8, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ai,
                         0);
    ...
    // Start for S-Function (CB_PWM): '<S285>/PWM'
    ...
    // Start for Atomic SubSystem: '<S286>/generation'
    // Start for S-Function (CB_PWM): '<S287>/PWM'
    ...
    // End of Start for SubSystem: '<S286>/generation'

    // Start for Atomic SubSystem: '<S288>/generation'
    // Start for S-Function (CB_PWM): '<S289>/PWM'
    ...
    // End of Start for SubSystem: '<S288>/generation'

    // Start for Atomic SubSystem: '<S294>/generation'
    // Start for S-Function (CB_PWM): '<S295>/PWM'
    ...
    // Start for S-Function (CB_PWM): '<S297>/PWM'
    ...
    // Start for Atomic SubSystem: '<S298>/generation'
    // Start for S-Function (CB_PWM): '<S299>/PWM'
    ...
    // End of Start for SubSystem: '<S298>/generation'

    // Start for Atomic SubSystem: '<S300>/generation'
    // Start for S-Function (CB_PWM): '<S301>/PWM'
    ...
    // End of Start for SubSystem: '<S300>/generation'

    // Start for Atomic SubSystem: '<S306>/generation'
    // Start for S-Function (CB_PWM): '<S307>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 4, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ek,
                         1);
    ...
    // Start for S-Function (CB_PWM): '<S309>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 5, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_i,
                         1);
    ...
    // Start for S-Function (CB_PWM): '<S311>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 6, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_m,
                         1);
    ...
    // Start for S-Function (CB_PWM): '<S313>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 7, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_gd,
                         1);
    ...
    // Start for S-Function (CB_PWM): '<S319>/PWM'
    ...
    // Start for S-Function (CB_PWM): '<S321>/PWM'
    ...
    // Start for Atomic SubSystem: '<S322>/generation'
    // Start for S-Function (CB_PWM): '<S323>/PWM'
    ...
    // End of Start for SubSystem: '<S322>/generation'

    // Start for Atomic SubSystem: '<S324>/generation'
    // Start for S-Function (CB_PWM): '<S325>/PWM'
    ...
    // End of Start for SubSystem: '<S324>/generation'

    // Start for Atomic SubSystem: '<S330>/generation'
    // Start for S-Function (CB_PWM): '<S331>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 0, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ib,
                         0);
    ...
    // Start for S-Function (CB_PWM): '<S333>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 1, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_pj,
                         0);
    ...
    // Start for S-Function (CB_PWM): '<S335>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 2, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_ddd,
                         0);
    ...
    // Start for S-Function (CB_PWM): '<S337>/PWM'
    CbPwm_ConfigureClock((tPwmOutput) 3, (tClock)
                         imperix_M2C_NN_control_2024b_B.TmpRTBAtgenerationInport3_fi,
                         0);
    ...
    imperix_M2C_NN_control__PrevZCX.Subsystem_Trig_ZCE = UNINITIALIZED_ZCSIG;

    // InitializeConditions for RateTransition generated from: '<S29>/Subsystem' 
    for (i = 0; i < 14; i++) {
      imperix_M2C_NN_control_2024b_DW.TmpRTBAtSubsystemInport1_Buffer[i] =
        imperix_M2C_NN_control_2024b_P.TmpRTBAtSubsystemInport1_Initia;
    }

    // End of InitializeConditions for RateTransition generated from: '<S29>/Subsystem' 
    ...
    imperix_M2C_NN_control_2024b_DW.obj_i.pCumSum = 0.0;
    imperix_M2C_NN_control_2024b_DW.obj_i.pCumRevIndex = 1.0;
    imperix_M2C_NN_control_2024b_DW.obj_i.pModValueRev = 0.0;

    // InitializeConditions for MATLABSystem: '<S1>/Moving RMS2'
    imperix_M2C_NN_control_2024b_DW.obj.pCumSum = 0.0;

    // InitializeConditions for MATLABSystem: '<S1>/Moving RMS1'
    std::memset(&imperix_M2C_NN_control_2024b_DW.obj_i.pCumSumRev[0], 0, 39U *
                sizeof(real_T));

    // InitializeConditions for MATLABSystem: '<S1>/Moving RMS2'
    std::memset(&imperix_M2C_NN_control_2024b_DW.obj.pCumSumRev[0], 0, 39U *
                sizeof(real_T));
    imperix_M2C_NN_control_2024b_DW.obj.pCumRevIndex = 1.0;
    imperix_M2C_NN_control_2024b_DW.obj.pModValueRev = 0.0;
  }
}
...
void imperix_M2C_NN_control_2024b_terminate(void)
{
  ...
  if (!imperix_M2C_NN_control_2024b_DW.obj_i.matlabCodegenIsDeleted) {
    imperix_M2C_NN_control_2024b_DW.obj_i.matlabCodegenIsDeleted = true;
    if ((imperix_M2C_NN_control_2024b_DW.obj_i.isInitialized == 1) &&
        imperix_M2C_NN_control_2024b_DW.obj_i.isSetupComplete) {
      imperix_M2C_NN_control_2024b_DW.obj_i.NumChannels = -1;
      imperix_M2C_NN_control_2024b_DW.obj_i.FrameLength = -1;
    }
  }
  ...
  // Terminate for MATLABSystem: '<S1>/Moving RMS2'
  if (!imperix_M2C_NN_control_2024b_DW.obj.matlabCodegenIsDeleted) {
    imperix_M2C_NN_control_2024b_DW.obj.matlabCodegenIsDeleted = true;
    if ((imperix_M2C_NN_control_2024b_DW.obj.isInitialized == 1) &&
        imperix_M2C_NN_control_2024b_DW.obj.isSetupComplete) {
      imperix_M2C_NN_control_2024b_DW.obj.NumChannels = -1;
      imperix_M2C_NN_control_2024b_DW.obj.FrameLength = -1;
    }
  }

  // End of Terminate for MATLABSystem: '<S1>/Moving RMS2'
}
