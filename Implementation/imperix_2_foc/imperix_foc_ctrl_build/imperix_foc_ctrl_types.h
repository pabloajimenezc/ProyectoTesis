...
//
#ifndef imperix_foc_ctrl_types_h_
#define imperix_foc_ctrl_types_h_
#include "rtwtypes.h"
...
#ifndef struct_cell_wrap_imperix_foc_ctrl_T
#define struct_cell_wrap_imperix_foc_ctrl_T

struct cell_wrap_imperix_foc_ctrl_T
{
  uint32_T f1[8];
};

#endif                                 // struct_cell_wrap_imperix_foc_ctrl_T
...
struct dsp_simulink_MovingAverage_im_T
{
  ...
  cell_wrap_imperix_foc_ctrl_T inputVarSize;
  int32_T NumChannels;
  int32_T FrameLength;
  real_T pCumSum;
...
typedef struct P_imperix_foc_ctrl_T_ P_imperix_foc_ctrl_T;

// Forward declaration for rtModel
typedef struct tag_RTM_imperix_foc_ctrl_T RT_MODEL_imperix_foc_ctrl_T;

#endif                                 // imperix_foc_ctrl_types_h_
