...
struct B_imperix_ctrl_T {
  ...
  real_T In;                           // '<S605>/In'
  real_T Fcn;                          // '<S562>/Fcn'
  real_T Fcn1;                         // '<S562>/Fcn1'
  real_T Fcn_c;                        // '<S561>/Fcn'
  real_T Fcn1_p;                       // '<S561>/Fcn1'
  real_T Fcn_b;                        // '<S489>/Fcn'
  real_T Fcn1_i;                       // '<S489>/Fcn1'
  real_T Fcn_d;                        // '<S488>/Fcn'
  real_T Fcn1_d;                       // '<S488>/Fcn1'
  real_T In_h[6];                      // '<S365>/In'
  real_T In_c[6];                      // '<S358>/In'
  ...
  real32_T SFunction;                  // '<S621>/S-Function'
  real32_T DataTypeConversion;         // '<S171>/Data Type Conversion'
  real32_T DataTypeConversion_h;       // '<S173>/Data Type Conversion'
  ...
  real32_T DataTypeConversion_c;       // '<S175>/Data Type Conversion'
  real32_T DataTypeConversion_k;       // '<S177>/Data Type Conversion'
  real32_T ADC_f;                      // '<S104>/ADC'
  real32_T DataTypeConversion_a;       // '<S179>/Data Type Conversion'
  real32_T SFunction_e;                // '<S627>/S-Function'
  real32_T SFunction_o;                // '<S631>/S-Function'
  real32_T DataTypeConversion_cf;      // '<S181>/Data Type Conversion'
  real32_T DataTypeConversion_e;       // '<S183>/Data Type Conversion'
  real32_T DataTypeConversion_p;       // '<S185>/Data Type Conversion'
  real32_T DataTypeConversion_o;       // '<S187>/Data Type Conversion'
  real32_T DataTypeConversion_k1;      // '<S189>/Data Type Conversion'
  real32_T DataTypeConversion_n;       // '<S191>/Data Type Conversion'
  real32_T SFunction_i;                // '<S619>/S-Function'
  real32_T SFunction_p;                // '<S625>/S-Function'
  real32_T SFunction_h;                // '<S629>/S-Function'
  real32_T DataTypeConversion_i;       // '<S193>/Data Type Conversion'
  real32_T DataTypeConversion_l;       // '<S195>/Data Type Conversion'
  real32_T DataTypeConversion_hg;      // '<S197>/Data Type Conversion'
  real32_T DataTypeConversion_as;      // '<S199>/Data Type Conversion'
  real32_T DataTypeConversion_f;       // '<S201>/Data Type Conversion'
  real32_T DataTypeConversion_il;      // '<S203>/Data Type Conversion'
  real32_T DataTypeConversion_ep;      // '<S205>/Data Type Conversion'
  real32_T DataTypeConversion_ly;      // '<S207>/Data Type Conversion'
  real32_T DataTypeConversion_hm;      // '<S209>/Data Type Conversion'
  real32_T DataTypeConversion_fv;      // '<S211>/Data Type Conversion'
  real32_T DataTypeConversion_nx;      // '<S213>/Data Type Conversion'
  real32_T DataTypeConversion_b;       // '<S215>/Data Type Conversion'
  real32_T DataTypeConversion_of;      // '<S217>/Data Type Conversion'
  real32_T DataTypeConversion_ch;      // '<S219>/Data Type Conversion'
  real32_T DataTypeConversion_cz;      // '<S221>/Data Type Conversion'
  real32_T DataTypeConversion_ci;      // '<S223>/Data Type Conversion'
  real32_T DataTypeConversion_k2;      // '<S225>/Data Type Conversion'
  real32_T ADC_h;                      // '<S84>/ADC'
  real32_T DataTypeConversion_nc;      // '<S227>/Data Type Conversion'
  real32_T DataTypeConversion_lx;      // '<S229>/Data Type Conversion'
  real32_T DataTypeConversion_kf;      // '<S231>/Data Type Conversion'
  real32_T DataTypeConversion_ex;      // '<S233>/Data Type Conversion'
  real32_T DataTypeConversion_p2;      // '<S235>/Data Type Conversion'
  real32_T DataTypeConversion_ok;      // '<S237>/Data Type Conversion'
  real32_T DataTypeConversion_j;       // '<S239>/Data Type Conversion'
  real32_T SFunction_c;                // '<S623>/S-Function'
  real32_T DataTypeConversion1_l;      // '<S346>/Data Type Conversion1'
  real32_T DataTypeConversion2_l;      // '<S346>/Data Type Conversion2'
  real32_T DataTypeConversion3;        // '<S346>/Data Type Conversion3'
  real32_T DataTypeConversion1_p;      // '<S347>/Data Type Conversion1'
  real32_T DataTypeConversion2_i;      // '<S347>/Data Type Conversion2'
  real32_T DataTypeConversion3_g;      // '<S347>/Data Type Conversion3'
  real32_T DataTypeConversion1_h;      // '<S348>/Data Type Conversion1'
  real32_T DataTypeConversion2_b;      // '<S348>/Data Type Conversion2'
  real32_T DataTypeConversion3_i;      // '<S348>/Data Type Conversion3'
  real32_T DataTypeConversion1_f;      // '<S349>/Data Type Conversion1'
  real32_T DataTypeConversion2_p;      // '<S349>/Data Type Conversion2'
  real32_T DataTypeConversion3_gf;     // '<S349>/Data Type Conversion3'
  real32_T DataTypeConversion_d;       // '<S367>/Data Type Conversion'
  real32_T DataTypeConversion_kc;      // '<S369>/Data Type Conversion'
  real32_T DataTypeConversion_e3;      // '<S371>/Data Type Conversion'
  real32_T DataTypeConversion_b2;      // '<S373>/Data Type Conversion'
  real32_T DataTypeConversion_ev;      // '<S375>/Data Type Conversion'
  real32_T DataTypeConversion_fn;      // '<S377>/Data Type Conversion'
  real32_T DataTypeConversion1_b;      // '<S490>/Data Type Conversion1'
  real32_T DataTypeConversion2_d;      // '<S490>/Data Type Conversion2'
  real32_T DataTypeConversion3_gp;     // '<S490>/Data Type Conversion3'
  real32_T DataTypeConversion1_e;      // '<S491>/Data Type Conversion1'
  real32_T DataTypeConversion2_o;      // '<S491>/Data Type Conversion2'
  real32_T DataTypeConversion3_gl;     // '<S491>/Data Type Conversion3'
  real32_T DataTypeConversion1_po;     // '<S492>/Data Type Conversion1'
  real32_T DataTypeConversion2_g;      // '<S492>/Data Type Conversion2'
  real32_T DataTypeConversion3_m;      // '<S492>/Data Type Conversion3'
  real32_T DataTypeConversion1_c;      // '<S493>/Data Type Conversion1'
  real32_T DataTypeConversion2_k;      // '<S493>/Data Type Conversion2'
  real32_T DataTypeConversion3_a;      // '<S493>/Data Type Conversion3'
  real32_T DataTypeConversion1_h3;     // '<S563>/Data Type Conversion1'
  real32_T DataTypeConversion2_bv;     // '<S563>/Data Type Conversion2'
  real32_T DataTypeConversion3_b;      // '<S563>/Data Type Conversion3'
  real32_T DataTypeConversion1_m;      // '<S564>/Data Type Conversion1'
  real32_T DataTypeConversion2_j;      // '<S564>/Data Type Conversion2'
  real32_T DataTypeConversion3_h;      // '<S564>/Data Type Conversion3'
  real32_T DataTypeConversion1_fz;     // '<S565>/Data Type Conversion1'
  real32_T DataTypeConversion2_a;      // '<S565>/Data Type Conversion2'
  real32_T DataTypeConversion3_e;      // '<S565>/Data Type Conversion3'
  real32_T DataTypeConversion1_i;      // '<S566>/Data Type Conversion1'
  real32_T DataTypeConversion2_f;      // '<S566>/Data Type Conversion2'
  real32_T DataTypeConversion3_k;      // '<S566>/Data Type Conversion3'
  real32_T DataTypeConversion1_a;      // '<S575>/Data Type Conversion1'
  real32_T DataTypeConversion2_dx;     // '<S575>/Data Type Conversion2'
  real32_T DataTypeConversion3_l;      // '<S575>/Data Type Conversion3'
  real32_T DataTypeConversion1_k;      // '<S576>/Data Type Conversion1'
  real32_T DataTypeConversion2_dm;     // '<S576>/Data Type Conversion2'
  real32_T DataTypeConversion3_n;      // '<S576>/Data Type Conversion3'
  real32_T DataTypeConversion1_l4;     // '<S577>/Data Type Conversion1'
  real32_T DataTypeConversion2_n;      // '<S577>/Data Type Conversion2'
  real32_T DataTypeConversion3_j;      // '<S577>/Data Type Conversion3'
  real32_T DataTypeConversion1_bg;     // '<S578>/Data Type Conversion1'
  real32_T DataTypeConversion2_nx;     // '<S578>/Data Type Conversion2'
  real32_T DataTypeConversion3_bs;     // '<S578>/Data Type Conversion3'
  real32_T DataTypeConversion1_d;      // '<S587>/Data Type Conversion1'
  real32_T DataTypeConversion2_pe;     // '<S587>/Data Type Conversion2'
  real32_T DataTypeConversion3_bsx;    // '<S587>/Data Type Conversion3'
  real32_T DataTypeConversion1_o;      // '<S588>/Data Type Conversion1'
  real32_T DataTypeConversion2_n0;     // '<S588>/Data Type Conversion2'
  real32_T DataTypeConversion3_hm;     // '<S588>/Data Type Conversion3'
  real32_T DataTypeConversion1_ay;     // '<S589>/Data Type Conversion1'
  real32_T DataTypeConversion2_gl;     // '<S589>/Data Type Conversion2'
  real32_T DataTypeConversion3_ip;     // '<S589>/Data Type Conversion3'
  real32_T DataTypeConversion1_pf;     // '<S590>/Data Type Conversion1'
  real32_T DataTypeConversion2_by;     // '<S590>/Data Type Conversion2'
  real32_T DataTypeConversion3_o;      // '<S590>/Data Type Conversion3'
  real32_T DataTypeConversion1_al;     // '<S606>/Data Type Conversion1'
  real32_T DataTypeConversion2_jw;     // '<S606>/Data Type Conversion2'
  real32_T DataTypeConversion3_d;      // '<S606>/Data Type Conversion3'
  real32_T DataTypeConversion1_ig;     // '<S607>/Data Type Conversion1'
  real32_T DataTypeConversion2_ij;     // '<S607>/Data Type Conversion2'
  real32_T DataTypeConversion3_bt;     // '<S607>/Data Type Conversion3'
  real32_T DataTypeConversion1_g;      // '<S608>/Data Type Conversion1'
  real32_T DataTypeConversion2_nm;     // '<S608>/Data Type Conversion2'
  real32_T DataTypeConversion3_p;      // '<S608>/Data Type Conversion3'
  real32_T DataTypeConversion1_gw;     // '<S609>/Data Type Conversion1'
  real32_T DataTypeConversion2_a0;     // '<S609>/Data Type Conversion2'
  real32_T DataTypeConversion3_bm;     // '<S609>/Data Type Conversion3'
...
struct DW_imperix_ctrl_T {
  ...
  real_T SFunction_DSTATE;             // '<S621>/S-Function'
  real_T SFunction_DSTATE_a;           // '<S171>/S-Function'
  real_T SFunction_DSTATE_aa;          // '<S173>/S-Function'
  real_T SFunction_DSTATE_j;           // '<S175>/S-Function'
  real_T SFunction_DSTATE_n;           // '<S177>/S-Function'
  real_T SFunction_DSTATE_f;           // '<S179>/S-Function'
  real_T UnitDelay_DSTATE[2];          // '<S63>/Unit Delay'
  real_T SFunction_DSTATE_b;           // '<S627>/S-Function'
  real_T SFunction_DSTATE_c;           // '<S631>/S-Function'
  real_T SFunction_DSTATE_cj;          // '<S181>/S-Function'
  real_T SFunction_DSTATE_i;           // '<S183>/S-Function'
  real_T SFunction_DSTATE_bm;          // '<S185>/S-Function'
  real_T UnitDelay1_DSTATE;            // '<S21>/Unit Delay1'
  real_T SFunction_DSTATE_o;           // '<S187>/S-Function'
  real_T Integrator_DSTATE;            // '<S152>/Integrator'
  real_T SFunction_DSTATE_jm;          // '<S189>/S-Function'
  real_T SFunction_DSTATE_p;           // '<S191>/S-Function'
  real_T SFunction_DSTATE_fo;          // '<S619>/S-Function'
  real_T SFunction_DSTATE_am;          // '<S625>/S-Function'
  real_T SFunction_DSTATE_iz;          // '<S629>/S-Function'
  real_T Integrator_DSTATE_d;          // '<S328>/Integrator'
  real_T Integrator_DSTATE_i;          // '<S276>/Integrator'
  real_T Integrator_DSTATE_j;          // '<S416>/Integrator'
  real_T Integrator_DSTATE_e;          // '<S468>/Integrator'
  real_T SFunction_DSTATE_f5;          // '<S193>/S-Function'
  real_T SFunction_DSTATE_d;           // '<S195>/S-Function'
  real_T SFunction_DSTATE_nw;          // '<S197>/S-Function'
  real_T SFunction_DSTATE_g;           // '<S199>/S-Function'
  real_T SFunction_DSTATE_o5;          // '<S201>/S-Function'
  real_T SFunction_DSTATE_k;           // '<S203>/S-Function'
  real_T SFunction_DSTATE_p0;          // '<S205>/S-Function'
  real_T SFunction_DSTATE_dq;          // '<S207>/S-Function'
  real_T SFunction_DSTATE_h;           // '<S209>/S-Function'
  real_T SFunction_DSTATE_e;           // '<S211>/S-Function'
  real_T SFunction_DSTATE_pb;          // '<S213>/S-Function'
  real_T SFunction_DSTATE_dh;          // '<S215>/S-Function'
  real_T SFunction_DSTATE_gh;          // '<S217>/S-Function'
  real_T SFunction_DSTATE_l;           // '<S219>/S-Function'
  real_T SFunction_DSTATE_fx;          // '<S221>/S-Function'
  real_T SFunction_DSTATE_lk;          // '<S223>/S-Function'
  real_T SFunction_DSTATE_fm;          // '<S225>/S-Function'
  real_T SFunction_DSTATE_na;          // '<S227>/S-Function'
  real_T SFunction_DSTATE_pq;          // '<S229>/S-Function'
  real_T SFunction_DSTATE_fg;          // '<S231>/S-Function'
  real_T SFunction_DSTATE_fc;          // '<S233>/S-Function'
  real_T SFunction_DSTATE_ai;          // '<S235>/S-Function'
  real_T SFunction_DSTATE_id;          // '<S237>/S-Function'
  real_T SFunction_DSTATE_pm;          // '<S239>/S-Function'
  real_T SFunction_DSTATE_fq;          // '<S623>/S-Function'
  real_T Integrator_DSTATE_p;          // '<S539>/Integrator'
  real_T SFunction_DSTATE_n5;          // '<S113>/S-Function'
  real_T SFunction_DSTATE_m;           // '<S367>/S-Function'
  real_T SFunction_DSTATE_i1;          // '<S369>/S-Function'
  real_T SFunction_DSTATE_jw;          // '<S371>/S-Function'
  real_T SFunction_DSTATE_fs;          // '<S373>/S-Function'
  real_T SFunction_DSTATE_mr;          // '<S375>/S-Function'
  real_T SFunction_DSTATE_jf;          // '<S377>/S-Function'
  ...
  int8_T Integrator_PrevResetState;    // '<S328>/Integrator'
  int8_T Integrator_PrevResetState_b;  // '<S276>/Integrator'
  int8_T Integrator_PrevResetState_n;  // '<S416>/Integrator'
  int8_T Integrator_PrevResetState_i;  // '<S468>/Integrator'
...
struct P_imperix_ctrl_T_ {
  ...
  struct_V11yzUicWajUfCfdcXdSaC FOC;   // Variable: FOC
                                          ...
                                          //    '<S268>/Kb'
                                          //    '<S273>/Integral Gain'
                                          //    '<S281>/Proportional Gain'
                                          //    '<S283>/Saturation'
                                          //    '<S320>/Kb'
                                          //    '<S325>/Integral Gain'
                                          //    '<S333>/Proportional Gain'
                                          //    '<S335>/Saturation'
  ...
  real_T SFunction_P17_p;              // Expression: double(CTRLPERIOD(1))
                                          //  Referenced by: '<S627>/S-Function'

  real_T SFunction_P17_h;              // Expression: double(CTRLPERIOD(1))
                                          //  Referenced by: '<S631>/S-Function'
  ...
  real_T phase_Value_c;                // Expression: PHASE
                                          //  Referenced by: '<S492>/phase'

  real_T phase_Value_ll;               // Expression: PHASE
                                          //  Referenced by: '<S493>/phase'

  real_T Clamping_zero_Value_a;        // Expression: 0
                                          //  Referenced by: '<S529>/Clamping_zero'
  ...
  real32_T CLK1_P2;                    // Expression: single(frequency)
                                          //  Referenced by: '<S115>/CLK1'

  real32_T SFunction_P6_jm;            // Expression: single(CAN_TX_FREQ)
                                          //  Referenced by: '<S367>/S-Function'

  real32_T SFunction_P12_nw;           // Expression: single(ETH_TX_FREQ)
                                          //  Referenced by: '<S367>/S-Function'

  real32_T SFunction_P6_fa;            // Expression: single(CAN_TX_FREQ)
                                          //  Referenced by: '<S369>/S-Function'

  real32_T SFunction_P12_na;           // Expression: single(ETH_TX_FREQ)
                                          //  Referenced by: '<S369>/S-Function'

  real32_T SFunction_P6_k1;            // Expression: single(CAN_TX_FREQ)
                                          //  Referenced by: '<S371>/S-Function'

  real32_T SFunction_P12_gk;           // Expression: single(ETH_TX_FREQ)
                                          //  Referenced by: '<S371>/S-Function'

  real32_T SFunction_P6_jr;            // Expression: single(CAN_TX_FREQ)
                                          //  Referenced by: '<S373>/S-Function'

  real32_T SFunction_P12_bz;           // Expression: single(ETH_TX_FREQ)
                                          //  Referenced by: '<S373>/S-Function'

  real32_T SFunction_P6_ks;            // Expression: single(CAN_TX_FREQ)
                                          //  Referenced by: '<S375>/S-Function'

  real32_T SFunction_P12_gi;           // Expression: single(ETH_TX_FREQ)
                                          //  Referenced by: '<S375>/S-Function'

  real32_T SFunction_P6_ke;            // Expression: single(CAN_TX_FREQ)
                                          //  Referenced by: '<S377>/S-Function'

  real32_T SFunction_P12_it;           // Expression: single(ETH_TX_FREQ)
                                          //  Referenced by: '<S377>/S-Function'
  ...
  uint32_T SFunction_P13_c0;           // Expression: uint32(ETH_PORT)
                                          //  Referenced by: '<S367>/S-Function'
  ...
  uint32_T SFunction_P7_agu;           // Expression: uint32(CAN_BAUDRATE)
                                          //  Referenced by: '<S373>/S-Function'

  uint32_T SFunction_P13_m;            // Expression: uint32(ETH_PORT)
                                          //  Referenced by: '<S373>/S-Function'

  uint32_T SFunction_P7_j1;            // Expression: uint32(CAN_BAUDRATE)
                                          //  Referenced by: '<S375>/S-Function'

  uint32_T SFunction_P13_ny;           // Expression: uint32(ETH_PORT)
                                          //  Referenced by: '<S375>/S-Function'

  uint32_T SFunction_P7_c3t;           // Expression: uint32(CAN_BAUDRATE)
                                          //  Referenced by: '<S377>/S-Function'

  uint32_T SFunction_P13_grv;          // Expression: uint32(ETH_PORT)
                                          //  Referenced by: '<S377>/S-Function'
  ...
  int16_T clk_id_Value;                // Computed Parameter: clk_id_Value
                                          //  Referenced by: '<S115>/clk_id'

  int16_T CLK1_P1;                     // Expression: int16(id)
                                          //  Referenced by: '<S115>/CLK1'

  int16_T SFunction_P2_cmj;            // Expression: int16(DATATYPE)
                                          //  Referenced by: '<S367>/S-Function'

  int16_T SFunction_P3_ik;             // Expression: int16(0)
                                          //  Referenced by: '<S367>/S-Function'

  int16_T SFunction_P2_pt;             // Expression: int16(DATATYPE)
                                          //  Referenced by: '<S369>/S-Function'

  int16_T SFunction_P3_dx;             // Expression: int16(0)
                                          //  Referenced by: '<S369>/S-Function'

  int16_T SFunction_P2_dr;             // Expression: int16(DATATYPE)
                                          //  Referenced by: '<S371>/S-Function'

  int16_T SFunction_P3_bl;             // Expression: int16(0)
                                          //  Referenced by: '<S371>/S-Function'
  ...
  int16_T SFunction_P2_ik;             // Expression: int16(DATATYPE)
                                          //  Referenced by: '<S375>/S-Function'

  int16_T SFunction_P3_ax;             // Expression: int16(0)
                                          //  Referenced by: '<S375>/S-Function'

  int16_T SFunction_P2_pw;             // Expression: int16(DATATYPE)
                                          //  Referenced by: '<S377>/S-Function'
  ...
  uint16_T SFunction_P1_fq[2];         // Computed Parameter: SFunction_P1_fq
                                          //  Referenced by: '<S367>/S-Function'

  uint16_T SFunction_P5_jw;            // Expression: uint16(CAN_MB_ID)
                                          //  Referenced by: '<S367>/S-Function'
  ...
  uint16_T SFunction_P14_e2[5];        // Computed Parameter: SFunction_P14_e2
                                          //  Referenced by: '<S367>/S-Function'

  uint16_T SFunction_P1_oy;            // Computed Parameter: SFunction_P1_oy
                                          //  Referenced by: '<S369>/S-Function'

  uint16_T SFunction_P5_ct;            // Expression: uint16(CAN_MB_ID)
                                          //  Referenced by: '<S369>/S-Function'

  uint16_T SFunction_P8_cs;            // Expression: uint16(CAN_ADDRESS)
                                          //  Referenced by: '<S369>/S-Function'
  ...
  uint16_T SFunction_P1_i22[3];        // Computed Parameter: SFunction_P1_i22
                                          //  Referenced by: '<S371>/S-Function'

  uint16_T SFunction_P5_bn;            // Expression: uint16(CAN_MB_ID)
                                          //  Referenced by: '<S371>/S-Function'

  uint16_T SFunction_P8_mw;            // Expression: uint16(CAN_ADDRESS)
                                          //  Referenced by: '<S371>/S-Function'

  uint16_T SFunction_P11_dw;           // Expression: uint16(ETH_MB_ID)
                                          //  Referenced by: '<S371>/S-Function'

  uint16_T SFunction_P14_m1[5];        // Computed Parameter: SFunction_P14_m1
                                          //  Referenced by: '<S371>/S-Function'

  uint16_T SFunction_P1_mz[4];         // Computed Parameter: SFunction_P1_mz
                                          //  Referenced by: '<S373>/S-Function'

  uint16_T SFunction_P5_n1;            // Expression: uint16(CAN_MB_ID)
                                          //  Referenced by: '<S373>/S-Function'

  uint16_T SFunction_P8_ey;            // Expression: uint16(CAN_ADDRESS)
                                          //  Referenced by: '<S373>/S-Function'

  uint16_T SFunction_P11_p4;           // Expression: uint16(ETH_MB_ID)
                                          //  Referenced by: '<S373>/S-Function'

  uint16_T SFunction_P14_jn[5];        // Computed Parameter: SFunction_P14_jn
                                          //  Referenced by: '<S373>/S-Function'

  uint16_T SFunction_P1_el[5];         // Computed Parameter: SFunction_P1_el
                                          //  Referenced by: '<S375>/S-Function'

  uint16_T SFunction_P5_h4;            // Expression: uint16(CAN_MB_ID)
                                          //  Referenced by: '<S375>/S-Function'

  uint16_T SFunction_P8_nu;            // Expression: uint16(CAN_ADDRESS)
                                          //  Referenced by: '<S375>/S-Function'

  uint16_T SFunction_P11_m3;           // Expression: uint16(ETH_MB_ID)
                                          //  Referenced by: '<S375>/S-Function'
  ...
  uint16_T SFunction_P5_pn;            // Expression: uint16(CAN_MB_ID)
                                          //  Referenced by: '<S377>/S-Function'

  uint16_T SFunction_P8_m3;            // Expression: uint16(CAN_ADDRESS)
                                          //  Referenced by: '<S377>/S-Function'

  uint16_T SFunction_P11_l5;           // Expression: uint16(ETH_MB_ID)
                                          //  Referenced by: '<S377>/S-Function'

  uint16_T SFunction_P14_ie3[5];       // Computed Parameter: SFunction_P14_ie3
                                          //  Referenced by: '<S377>/S-Function'
  ...
  boolean_T SFunction_P9_nv;           // Expression: boolean(CAN_BIG_ENDIAN)
                                          //  Referenced by: '<S367>/S-Function'

  boolean_T SFunction_P10_lw;          // Expression: boolean(ETH_ENABLED)
                                          //  Referenced by: '<S367>/S-Function'

  boolean_T SFunction_P15_ac;          // Expression: boolean(ETH_BIG_ENDIAN)
                                          //  Referenced by: '<S367>/S-Function'

  boolean_T SFunction_P4_gm;           // Expression: boolean(CAN_ENABLED)
                                          //  Referenced by: '<S369>/S-Function'

  boolean_T SFunction_P9_lj;           // Expression: boolean(CAN_BIG_ENDIAN)
                                          //  Referenced by: '<S369>/S-Function'

  boolean_T SFunction_P10_hm;          // Expression: boolean(ETH_ENABLED)
                                          //  Referenced by: '<S369>/S-Function'

  boolean_T SFunction_P15_ih;          // Expression: boolean(ETH_BIG_ENDIAN)
                                          //  Referenced by: '<S369>/S-Function'

  boolean_T SFunction_P4_eh;           // Expression: boolean(CAN_ENABLED)
                                          //  Referenced by: '<S371>/S-Function'

  boolean_T SFunction_P9_cg;           // Expression: boolean(CAN_BIG_ENDIAN)
                                          //  Referenced by: '<S371>/S-Function'

  boolean_T SFunction_P10_g2;          // Expression: boolean(ETH_ENABLED)
                                          //  Referenced by: '<S371>/S-Function'

  boolean_T SFunction_P15_dw;          // Expression: boolean(ETH_BIG_ENDIAN)
                                          //  Referenced by: '<S371>/S-Function'

  boolean_T SFunction_P4_fh;           // Expression: boolean(CAN_ENABLED)
                                          //  Referenced by: '<S373>/S-Function'

  boolean_T SFunction_P9_ge;           // Expression: boolean(CAN_BIG_ENDIAN)
                                          //  Referenced by: '<S373>/S-Function'

  boolean_T SFunction_P10_kq;          // Expression: boolean(ETH_ENABLED)
                                          //  Referenced by: '<S373>/S-Function'

  boolean_T SFunction_P15_bk;          // Expression: boolean(ETH_BIG_ENDIAN)
                                          //  Referenced by: '<S373>/S-Function'

  boolean_T SFunction_P4_gy;           // Expression: boolean(CAN_ENABLED)
                                          //  Referenced by: '<S375>/S-Function'

  boolean_T SFunction_P9_cf;           // Expression: boolean(CAN_BIG_ENDIAN)
                                          //  Referenced by: '<S375>/S-Function'

  boolean_T SFunction_P10_ni;          // Expression: boolean(ETH_ENABLED)
                                          //  Referenced by: '<S375>/S-Function'

  boolean_T SFunction_P15_f0;          // Expression: boolean(ETH_BIG_ENDIAN)
                                          //  Referenced by: '<S375>/S-Function'

  boolean_T SFunction_P4_az;           // Expression: boolean(CAN_ENABLED)
                                          //  Referenced by: '<S377>/S-Function'

  boolean_T SFunction_P9_pa;           // Expression: boolean(CAN_BIG_ENDIAN)
                                          //  Referenced by: '<S377>/S-Function'

  boolean_T SFunction_P10_do;          // Expression: boolean(ETH_ENABLED)
                                          //  Referenced by: '<S377>/S-Function'

  boolean_T SFunction_P15_jc;          // Expression: boolean(ETH_BIG_ENDIAN)
                                          //  Referenced by: '<S377>/S-Function'
...
//
//  Block '<S378>/Gain3' : Unused code path elimination
...
//  Block '<S599>/Gain3' : Unused code path elimination
//  Block '<S603>/Fcn' : Unused code path elimination
//  Block '<S603>/Fcn1' : Unused code path elimination
//  Block '<S604>/Fcn' : Unused code path elimination
//  Block '<S604>/Fcn1' : Unused code path elimination
...
//  '<S111>' : 'imperix_ctrl/Closed_loop_control/Configuration/Sampling clock'
//  '<S112>' : 'imperix_ctrl/Closed_loop_control/Configuration/clk0'
//  '<S113>' : 'imperix_ctrl/Closed_loop_control/Configuration/Sampling clock/generation'
//  '<S114>' : 'imperix_ctrl/Closed_loop_control/Configuration/clk0/sub'
//  '<S115>' : 'imperix_ctrl/Closed_loop_control/Configuration/clk0/sub/generation'
//  '<S116>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Anti-windup'
//  '<S117>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/D Gain'
//  '<S118>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/External Derivative'
//  '<S119>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Filter'
//  '<S120>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Filter ICs'
//  '<S121>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/I Gain'
//  '<S122>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Ideal P Gain'
//  '<S123>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Ideal P Gain Fdbk'
//  '<S124>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Integrator'
//  '<S125>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Integrator ICs'
//  '<S126>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/N Copy'
//  '<S127>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/N Gain'
//  '<S128>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/P Copy'
//  '<S129>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Parallel P Gain'
//  '<S130>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Reset Signal'
//  '<S131>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Saturation'
//  '<S132>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Saturation Fdbk'
//  '<S133>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Sum'
//  '<S134>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Sum Fdbk'
//  '<S135>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Tracking Mode'
//  '<S136>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Tracking Mode Sum'
//  '<S137>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Tsamp - Integral'
//  '<S138>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Tsamp - Ngain'
//  '<S139>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/postSat Signal'
//  '<S140>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/preInt Signal'
//  '<S141>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/preSat Signal'
//  '<S142>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Anti-windup/Disc. Clamping Parallel'
//  '<S143>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Anti-windup/Disc. Clamping Parallel/Dead Zone'
//  '<S144>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Anti-windup/Disc. Clamping Parallel/Dead Zone/Enabled'
//  '<S145>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/D Gain/Disabled'
//  '<S146>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/External Derivative/Disabled'
//  '<S147>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Filter/Disabled'
//  '<S148>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Filter ICs/Disabled'
//  '<S149>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/I Gain/Internal Parameters'
//  '<S150>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Ideal P Gain/Passthrough'
//  '<S151>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Ideal P Gain Fdbk/Disabled'
//  '<S152>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Integrator/Discrete'
//  '<S153>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Integrator ICs/Internal IC'
//  '<S154>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/N Copy/Disabled wSignal Specification'
//  '<S155>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/N Gain/Disabled'
//  '<S156>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/P Copy/Disabled'
//  '<S157>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Parallel P Gain/Internal Parameters'
//  '<S158>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Reset Signal/Disabled'
//  '<S159>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Saturation/Enabled'
//  '<S160>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Saturation Fdbk/Disabled'
//  '<S161>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Sum/Sum_PI'
//  '<S162>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Sum Fdbk/Disabled'
//  '<S163>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Tracking Mode/Disabled'
//  '<S164>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Tracking Mode Sum/Passthrough'
//  '<S165>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Tsamp - Integral/TsSignalSpecification'
//  '<S166>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/Tsamp - Ngain/Passthrough'
//  '<S167>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/postSat Signal/Forward_Path'
//  '<S168>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/preInt Signal/Internal PreInt'
//  '<S169>' : 'imperix_ctrl/Closed_loop_control/PID Controller1/preSat Signal/Forward_Path'
//  '<S170>' : 'imperix_ctrl/Closed_loop_control/Probe/sub'
//  '<S171>' : 'imperix_ctrl/Closed_loop_control/Probe/sub/generation'
//  '<S172>' : 'imperix_ctrl/Closed_loop_control/Probe1/sub'
//  '<S173>' : 'imperix_ctrl/Closed_loop_control/Probe1/sub/generation'
//  '<S174>' : 'imperix_ctrl/Closed_loop_control/Probe10/sub'
//  '<S175>' : 'imperix_ctrl/Closed_loop_control/Probe10/sub/generation'
//  '<S176>' : 'imperix_ctrl/Closed_loop_control/Probe11/sub'
//  '<S177>' : 'imperix_ctrl/Closed_loop_control/Probe11/sub/generation'
//  '<S178>' : 'imperix_ctrl/Closed_loop_control/Probe12/sub'
//  '<S179>' : 'imperix_ctrl/Closed_loop_control/Probe12/sub/generation'
//  '<S180>' : 'imperix_ctrl/Closed_loop_control/Probe18/sub'
//  '<S181>' : 'imperix_ctrl/Closed_loop_control/Probe18/sub/generation'
//  '<S182>' : 'imperix_ctrl/Closed_loop_control/Probe19/sub'
//  '<S183>' : 'imperix_ctrl/Closed_loop_control/Probe19/sub/generation'
//  '<S184>' : 'imperix_ctrl/Closed_loop_control/Probe2/sub'
//  '<S185>' : 'imperix_ctrl/Closed_loop_control/Probe2/sub/generation'
//  '<S186>' : 'imperix_ctrl/Closed_loop_control/Probe20/sub'
//  '<S187>' : 'imperix_ctrl/Closed_loop_control/Probe20/sub/generation'
//  '<S188>' : 'imperix_ctrl/Closed_loop_control/Probe21/sub'
//  '<S189>' : 'imperix_ctrl/Closed_loop_control/Probe21/sub/generation'
//  '<S190>' : 'imperix_ctrl/Closed_loop_control/Probe22/sub'
//  '<S191>' : 'imperix_ctrl/Closed_loop_control/Probe22/sub/generation'
//  '<S192>' : 'imperix_ctrl/Closed_loop_control/Probe23/sub'
//  '<S193>' : 'imperix_ctrl/Closed_loop_control/Probe23/sub/generation'
//  '<S194>' : 'imperix_ctrl/Closed_loop_control/Probe24/sub'
//  '<S195>' : 'imperix_ctrl/Closed_loop_control/Probe24/sub/generation'
//  '<S196>' : 'imperix_ctrl/Closed_loop_control/Probe25/sub'
//  '<S197>' : 'imperix_ctrl/Closed_loop_control/Probe25/sub/generation'
//  '<S198>' : 'imperix_ctrl/Closed_loop_control/Probe26/sub'
//  '<S199>' : 'imperix_ctrl/Closed_loop_control/Probe26/sub/generation'
//  '<S200>' : 'imperix_ctrl/Closed_loop_control/Probe27/sub'
//  '<S201>' : 'imperix_ctrl/Closed_loop_control/Probe27/sub/generation'
//  '<S202>' : 'imperix_ctrl/Closed_loop_control/Probe28/sub'
//  '<S203>' : 'imperix_ctrl/Closed_loop_control/Probe28/sub/generation'
//  '<S204>' : 'imperix_ctrl/Closed_loop_control/Probe29/sub'
//  '<S205>' : 'imperix_ctrl/Closed_loop_control/Probe29/sub/generation'
//  '<S206>' : 'imperix_ctrl/Closed_loop_control/Probe3/sub'
//  '<S207>' : 'imperix_ctrl/Closed_loop_control/Probe3/sub/generation'
//  '<S208>' : 'imperix_ctrl/Closed_loop_control/Probe30/sub'
//  '<S209>' : 'imperix_ctrl/Closed_loop_control/Probe30/sub/generation'
//  '<S210>' : 'imperix_ctrl/Closed_loop_control/Probe31/sub'
//  '<S211>' : 'imperix_ctrl/Closed_loop_control/Probe31/sub/generation'
//  '<S212>' : 'imperix_ctrl/Closed_loop_control/Probe32/sub'
//  '<S213>' : 'imperix_ctrl/Closed_loop_control/Probe32/sub/generation'
//  '<S214>' : 'imperix_ctrl/Closed_loop_control/Probe33/sub'
//  '<S215>' : 'imperix_ctrl/Closed_loop_control/Probe33/sub/generation'
//  '<S216>' : 'imperix_ctrl/Closed_loop_control/Probe34/sub'
//  '<S217>' : 'imperix_ctrl/Closed_loop_control/Probe34/sub/generation'
//  '<S218>' : 'imperix_ctrl/Closed_loop_control/Probe35/sub'
//  '<S219>' : 'imperix_ctrl/Closed_loop_control/Probe35/sub/generation'
//  '<S220>' : 'imperix_ctrl/Closed_loop_control/Probe36/sub'
//  '<S221>' : 'imperix_ctrl/Closed_loop_control/Probe36/sub/generation'
//  '<S222>' : 'imperix_ctrl/Closed_loop_control/Probe37/sub'
//  '<S223>' : 'imperix_ctrl/Closed_loop_control/Probe37/sub/generation'
//  '<S224>' : 'imperix_ctrl/Closed_loop_control/Probe38/sub'
//  '<S225>' : 'imperix_ctrl/Closed_loop_control/Probe38/sub/generation'
//  '<S226>' : 'imperix_ctrl/Closed_loop_control/Probe39/sub'
//  '<S227>' : 'imperix_ctrl/Closed_loop_control/Probe39/sub/generation'
//  '<S228>' : 'imperix_ctrl/Closed_loop_control/Probe4/sub'
//  '<S229>' : 'imperix_ctrl/Closed_loop_control/Probe4/sub/generation'
//  '<S230>' : 'imperix_ctrl/Closed_loop_control/Probe5/sub'
//  '<S231>' : 'imperix_ctrl/Closed_loop_control/Probe5/sub/generation'
//  '<S232>' : 'imperix_ctrl/Closed_loop_control/Probe6/sub'
//  '<S233>' : 'imperix_ctrl/Closed_loop_control/Probe6/sub/generation'
//  '<S234>' : 'imperix_ctrl/Closed_loop_control/Probe7/sub'
//  '<S235>' : 'imperix_ctrl/Closed_loop_control/Probe7/sub/generation'
//  '<S236>' : 'imperix_ctrl/Closed_loop_control/Probe8/sub'
//  '<S237>' : 'imperix_ctrl/Closed_loop_control/Probe8/sub/generation'
//  '<S238>' : 'imperix_ctrl/Closed_loop_control/Probe9/sub'
//  '<S239>' : 'imperix_ctrl/Closed_loop_control/Probe9/sub/generation'
//  '<S240>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI'
//  '<S241>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI'
//  '<S242>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Anti-windup'
//  '<S243>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/D Gain'
//  '<S244>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/External Derivative'
//  '<S245>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Filter'
//  '<S246>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Filter ICs'
//  '<S247>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/I Gain'
//  '<S248>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Ideal P Gain'
//  '<S249>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Ideal P Gain Fdbk'
//  '<S250>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Integrator'
//  '<S251>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Integrator ICs'
//  '<S252>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/N Copy'
//  '<S253>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/N Gain'
//  '<S254>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/P Copy'
//  '<S255>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Parallel P Gain'
//  '<S256>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Reset Signal'
//  '<S257>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Saturation'
//  '<S258>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Saturation Fdbk'
//  '<S259>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Sum'
//  '<S260>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Sum Fdbk'
//  '<S261>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Tracking Mode'
//  '<S262>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Tracking Mode Sum'
//  '<S263>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Tsamp - Integral'
//  '<S264>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Tsamp - Ngain'
//  '<S265>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/postSat Signal'
//  '<S266>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/preInt Signal'
//  '<S267>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/preSat Signal'
//  '<S268>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Anti-windup/Back Calculation'
//  '<S269>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/D Gain/Disabled'
//  '<S270>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/External Derivative/Disabled'
//  '<S271>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Filter/Disabled'
//  '<S272>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Filter ICs/Disabled'
//  '<S273>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/I Gain/Internal Parameters'
//  '<S274>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Ideal P Gain/Passthrough'
//  '<S275>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Ideal P Gain Fdbk/Disabled'
//  '<S276>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Integrator/Discrete'
//  '<S277>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Integrator ICs/Internal IC'
//  '<S278>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/N Copy/Disabled wSignal Specification'
//  '<S279>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/N Gain/Disabled'
//  '<S280>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/P Copy/Disabled'
//  '<S281>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Parallel P Gain/Internal Parameters'
//  '<S282>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Reset Signal/External Reset'
//  '<S283>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Saturation/Enabled'
//  '<S284>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Saturation Fdbk/Disabled'
//  '<S285>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Sum/Sum_PI'
//  '<S286>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Sum Fdbk/Disabled'
//  '<S287>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Tracking Mode/Disabled'
//  '<S288>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Tracking Mode Sum/Passthrough'
//  '<S289>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Tsamp - Integral/TsSignalSpecification'
//  '<S290>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/Tsamp - Ngain/Passthrough'
//  '<S291>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/postSat Signal/Forward_Path'
//  '<S292>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/preInt Signal/Internal PreInt'
//  '<S293>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Flux PI/preSat Signal/Forward_Path'
//  '<S294>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Anti-windup'
//  '<S295>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/D Gain'
//  '<S296>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/External Derivative'
//  '<S297>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Filter'
//  '<S298>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Filter ICs'
//  '<S299>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/I Gain'
//  '<S300>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Ideal P Gain'
//  '<S301>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Ideal P Gain Fdbk'
//  '<S302>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Integrator'
//  '<S303>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Integrator ICs'
//  '<S304>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/N Copy'
//  '<S305>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/N Gain'
//  '<S306>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/P Copy'
//  '<S307>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Parallel P Gain'
//  '<S308>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Reset Signal'
//  '<S309>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Saturation'
//  '<S310>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Saturation Fdbk'
//  '<S311>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Sum'
//  '<S312>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Sum Fdbk'
//  '<S313>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Tracking Mode'
//  '<S314>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Tracking Mode Sum'
//  '<S315>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Tsamp - Integral'
//  '<S316>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Tsamp - Ngain'
//  '<S317>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/postSat Signal'
//  '<S318>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/preInt Signal'
//  '<S319>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/preSat Signal'
//  '<S320>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Anti-windup/Back Calculation'
//  '<S321>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/D Gain/Disabled'
//  '<S322>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/External Derivative/Disabled'
//  '<S323>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Filter/Disabled'
//  '<S324>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Filter ICs/Disabled'
//  '<S325>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/I Gain/Internal Parameters'
//  '<S326>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Ideal P Gain/Passthrough'
//  '<S327>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Ideal P Gain Fdbk/Disabled'
//  '<S328>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Integrator/Discrete'
//  '<S329>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Integrator ICs/Internal IC'
//  '<S330>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/N Copy/Disabled wSignal Specification'
//  '<S331>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/N Gain/Disabled'
//  '<S332>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/P Copy/Disabled'
//  '<S333>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Parallel P Gain/Internal Parameters'
//  '<S334>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Reset Signal/External Reset'
//  '<S335>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Saturation/Enabled'
//  '<S336>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Saturation Fdbk/Disabled'
//  '<S337>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Sum/Sum_PI'
//  '<S338>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Sum Fdbk/Disabled'
//  '<S339>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Tracking Mode/Disabled'
//  '<S340>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Tracking Mode Sum/Passthrough'
//  '<S341>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Tsamp - Integral/TsSignalSpecification'
//  '<S342>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/Tsamp - Ngain/Passthrough'
//  '<S343>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/postSat Signal/Forward_Path'
//  '<S344>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/preInt Signal/Internal PreInt'
//  '<S345>' : 'imperix_ctrl/Closed_loop_control/Subsystem/Speed PI/preSat Signal/Forward_Path'
//  '<S346>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB'
//  '<S347>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB1'
//  '<S348>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB2'
//  '<S349>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB3'
//  '<S350>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB/sub'
//  '<S351>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB/sub/generation'
//  '<S352>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB1/sub'
//  '<S353>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB1/sub/generation'
//  '<S354>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB2/sub'
//  '<S355>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB2/sub/generation'
//  '<S356>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB3/sub'
//  '<S357>' : 'imperix_ctrl/Closed_loop_control/Subsystem1/PWM_CB3/sub/generation'
//  '<S358>' : 'imperix_ctrl/Closed_loop_control/Subsystem10/Sample and Hold'
//  '<S359>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe'
//  '<S360>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe1'
//  '<S361>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe2'
//  '<S362>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe3'
//  '<S363>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe4'
//  '<S364>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe5'
//  '<S365>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Sample and Hold'
//  '<S366>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe/sub'
//  '<S367>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe/sub/generation'
//  '<S368>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe1/sub'
//  '<S369>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe1/sub/generation'
//  '<S370>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe2/sub'
//  '<S371>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe2/sub/generation'
//  '<S372>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe3/sub'
//  '<S373>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe3/sub/generation'
//  '<S374>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe4/sub'
//  '<S375>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe4/sub/generation'
//  '<S376>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe5/sub'
//  '<S377>' : 'imperix_ctrl/Closed_loop_control/Subsystem11/Probe5/sub/generation'
//  '<S378>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/Alpha-Beta-Zero to abc'
//  '<S379>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d'
//  '<S380>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q '
//  '<S381>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/dq0 to Alpha-Beta-Zero'
//  '<S382>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Anti-windup'
//  '<S383>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/D Gain'
//  '<S384>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/External Derivative'
//  '<S385>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Filter'
//  '<S386>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Filter ICs'
//  '<S387>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/I Gain'
//  '<S388>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Ideal P Gain'
//  '<S389>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Ideal P Gain Fdbk'
//  '<S390>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Integrator'
//  '<S391>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Integrator ICs'
//  '<S392>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/N Copy'
//  '<S393>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/N Gain'
//  '<S394>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/P Copy'
//  '<S395>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Parallel P Gain'
//  '<S396>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Reset Signal'
//  '<S397>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Saturation'
//  '<S398>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Saturation Fdbk'
//  '<S399>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Sum'
//  '<S400>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Sum Fdbk'
//  '<S401>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Tracking Mode'
//  '<S402>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Tracking Mode Sum'
//  '<S403>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Tsamp - Integral'
//  '<S404>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Tsamp - Ngain'
//  '<S405>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/postSat Signal'
//  '<S406>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/preInt Signal'
//  '<S407>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/preSat Signal'
//  '<S408>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Anti-windup/Back Calculation'
//  '<S409>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/D Gain/Disabled'
//  '<S410>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/External Derivative/Disabled'
//  '<S411>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Filter/Disabled'
//  '<S412>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Filter ICs/Disabled'
//  '<S413>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/I Gain/Internal Parameters'
//  '<S414>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Ideal P Gain/Passthrough'
//  '<S415>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Ideal P Gain Fdbk/Disabled'
//  '<S416>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Integrator/Discrete'
//  '<S417>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Integrator ICs/Internal IC'
//  '<S418>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/N Copy/Disabled wSignal Specification'
//  '<S419>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/N Gain/Disabled'
//  '<S420>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/P Copy/Disabled'
//  '<S421>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Parallel P Gain/Internal Parameters'
//  '<S422>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Reset Signal/External Reset'
//  '<S423>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Saturation/Enabled'
//  '<S424>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Saturation Fdbk/Disabled'
//  '<S425>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Sum/Sum_PI'
//  '<S426>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Sum Fdbk/Disabled'
//  '<S427>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Tracking Mode/Disabled'
//  '<S428>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Tracking Mode Sum/Passthrough'
//  '<S429>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Tsamp - Integral/TsSignalSpecification'
//  '<S430>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/Tsamp - Ngain/Passthrough'
//  '<S431>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/postSat Signal/Forward_Path'
//  '<S432>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/preInt Signal/Internal PreInt'
//  '<S433>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI d/preSat Signal/Forward_Path'
//  '<S434>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Anti-windup'
//  '<S435>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /D Gain'
//  '<S436>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /External Derivative'
//  '<S437>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Filter'
//  '<S438>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Filter ICs'
//  '<S439>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /I Gain'
//  '<S440>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Ideal P Gain'
//  '<S441>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Ideal P Gain Fdbk'
//  '<S442>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Integrator'
//  '<S443>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Integrator ICs'
//  '<S444>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /N Copy'
//  '<S445>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /N Gain'
//  '<S446>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /P Copy'
//  '<S447>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Parallel P Gain'
//  '<S448>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Reset Signal'
//  '<S449>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Saturation'
//  '<S450>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Saturation Fdbk'
//  '<S451>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Sum'
//  '<S452>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Sum Fdbk'
//  '<S453>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Tracking Mode'
//  '<S454>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Tracking Mode Sum'
//  '<S455>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Tsamp - Integral'
//  '<S456>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Tsamp - Ngain'
//  '<S457>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /postSat Signal'
//  '<S458>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /preInt Signal'
//  '<S459>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /preSat Signal'
//  '<S460>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Anti-windup/Back Calculation'
//  '<S461>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /D Gain/Disabled'
//  '<S462>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /External Derivative/Disabled'
//  '<S463>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Filter/Disabled'
//  '<S464>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Filter ICs/Disabled'
//  '<S465>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /I Gain/Internal Parameters'
//  '<S466>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Ideal P Gain/Passthrough'
//  '<S467>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Ideal P Gain Fdbk/Disabled'
//  '<S468>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Integrator/Discrete'
//  '<S469>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Integrator ICs/Internal IC'
//  '<S470>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /N Copy/Disabled wSignal Specification'
//  '<S471>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /N Gain/Disabled'
//  '<S472>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /P Copy/Disabled'
//  '<S473>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Parallel P Gain/Internal Parameters'
//  '<S474>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Reset Signal/External Reset'
//  '<S475>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Saturation/Enabled'
//  '<S476>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Saturation Fdbk/Disabled'
//  '<S477>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Sum/Sum_PI'
//  '<S478>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Sum Fdbk/Disabled'
//  '<S479>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Tracking Mode/Disabled'
//  '<S480>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Tracking Mode Sum/Passthrough'
//  '<S481>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Tsamp - Integral/TsSignalSpecification'
//  '<S482>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /Tsamp - Ngain/Passthrough'
//  '<S483>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /postSat Signal/Forward_Path'
//  '<S484>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /preInt Signal/Internal PreInt'
//  '<S485>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/MCC PI q /preSat Signal/Forward_Path'
//  '<S486>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/dq0 to Alpha-Beta-Zero/Compare To Constant'
//  '<S487>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/dq0 to Alpha-Beta-Zero/Compare To Constant1'
//  '<S488>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/dq0 to Alpha-Beta-Zero/Subsystem - pi//2 delay'
//  '<S489>' : 'imperix_ctrl/Closed_loop_control/Subsystem19/dq0 to Alpha-Beta-Zero/Subsystem1'
//  '<S490>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB'
//  '<S491>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB1'
//  '<S492>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB2'
//  '<S493>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB3'
//  '<S494>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB/sub'
//  '<S495>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB/sub/generation'
//  '<S496>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB1/sub'
//  '<S497>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB1/sub/generation'
//  '<S498>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB2/sub'
//  '<S499>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB2/sub/generation'
//  '<S500>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB3/sub'
//  '<S501>' : 'imperix_ctrl/Closed_loop_control/Subsystem2/PWM_CB3/sub/generation'
//  '<S502>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI'
//  '<S503>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Anti-windup'
//  '<S504>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/D Gain'
//  '<S505>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/External Derivative'
//  '<S506>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Filter'
//  '<S507>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Filter ICs'
//  '<S508>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/I Gain'
//  '<S509>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Ideal P Gain'
//  '<S510>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Ideal P Gain Fdbk'
//  '<S511>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Integrator'
//  '<S512>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Integrator ICs'
//  '<S513>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/N Copy'
//  '<S514>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/N Gain'
//  '<S515>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/P Copy'
//  '<S516>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Parallel P Gain'
//  '<S517>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Reset Signal'
//  '<S518>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Saturation'
//  '<S519>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Saturation Fdbk'
//  '<S520>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Sum'
//  '<S521>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Sum Fdbk'
//  '<S522>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Tracking Mode'
//  '<S523>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Tracking Mode Sum'
//  '<S524>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Tsamp - Integral'
//  '<S525>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Tsamp - Ngain'
//  '<S526>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/postSat Signal'
//  '<S527>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/preInt Signal'
//  '<S528>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/preSat Signal'
//  '<S529>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Anti-windup/Disc. Clamping Parallel'
//  '<S530>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Anti-windup/Disc. Clamping Parallel/Dead Zone'
//  '<S531>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Anti-windup/Disc. Clamping Parallel/Dead Zone/Enabled'
//  '<S532>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/D Gain/Disabled'
//  '<S533>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/External Derivative/Disabled'
//  '<S534>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Filter/Disabled'
//  '<S535>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Filter ICs/Disabled'
//  '<S536>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/I Gain/Internal Parameters'
//  '<S537>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Ideal P Gain/Passthrough'
//  '<S538>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Ideal P Gain Fdbk/Disabled'
//  '<S539>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Integrator/Discrete'
//  '<S540>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Integrator ICs/Internal IC'
//  '<S541>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/N Copy/Disabled wSignal Specification'
//  '<S542>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/N Gain/Disabled'
//  '<S543>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/P Copy/Disabled'
//  '<S544>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Parallel P Gain/Internal Parameters'
//  '<S545>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Reset Signal/Disabled'
//  '<S546>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Saturation/Enabled'
//  '<S547>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Saturation Fdbk/Disabled'
//  '<S548>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Sum/Sum_PI'
//  '<S549>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Sum Fdbk/Disabled'
//  '<S550>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Tracking Mode/Disabled'
//  '<S551>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Tracking Mode Sum/Passthrough'
//  '<S552>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Tsamp - Integral/TsSignalSpecification'
//  '<S553>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/Tsamp - Ngain/Passthrough'
//  '<S554>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/postSat Signal/Forward_Path'
//  '<S555>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/preInt Signal/Internal PreInt'
//  '<S556>' : 'imperix_ctrl/Closed_loop_control/Subsystem23/PCC PI/preSat Signal/Forward_Path'
//  '<S557>' : 'imperix_ctrl/Closed_loop_control/Subsystem26/Alpha-Beta-Zero to dq0'
//  '<S558>' : 'imperix_ctrl/Closed_loop_control/Subsystem26/abc to Alpha-Beta-Zero'
//  '<S559>' : 'imperix_ctrl/Closed_loop_control/Subsystem26/Alpha-Beta-Zero to dq0/Compare To Constant'
//  '<S560>' : 'imperix_ctrl/Closed_loop_control/Subsystem26/Alpha-Beta-Zero to dq0/Compare To Constant1'
//  '<S561>' : 'imperix_ctrl/Closed_loop_control/Subsystem26/Alpha-Beta-Zero to dq0/Subsystem - pi//2 delay'
//  '<S562>' : 'imperix_ctrl/Closed_loop_control/Subsystem26/Alpha-Beta-Zero to dq0/Subsystem1'
//  '<S563>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB'
//  '<S564>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB1'
//  '<S565>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB2'
//  '<S566>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB3'
//  '<S567>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB/sub'
//  '<S568>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB/sub/generation'
//  '<S569>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB1/sub'
//  '<S570>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB1/sub/generation'
//  '<S571>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB2/sub'
//  '<S572>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB2/sub/generation'
//  '<S573>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB3/sub'
//  '<S574>' : 'imperix_ctrl/Closed_loop_control/Subsystem3/PWM_CB3/sub/generation'
//  '<S575>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB'
//  '<S576>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB1'
//  '<S577>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB2'
//  '<S578>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB3'
//  '<S579>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB/sub'
//  '<S580>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB/sub/generation'
//  '<S581>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB1/sub'
//  '<S582>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB1/sub/generation'
//  '<S583>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB2/sub'
//  '<S584>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB2/sub/generation'
//  '<S585>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB3/sub'
//  '<S586>' : 'imperix_ctrl/Closed_loop_control/Subsystem4/PWM_CB3/sub/generation'
//  '<S587>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB'
//  '<S588>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB1'
//  '<S589>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB2'
//  '<S590>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB3'
//  '<S591>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB/sub'
//  '<S592>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB/sub/generation'
//  '<S593>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB1/sub'
//  '<S594>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB1/sub/generation'
//  '<S595>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB2/sub'
//  '<S596>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB2/sub/generation'
//  '<S597>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB3/sub'
//  '<S598>' : 'imperix_ctrl/Closed_loop_control/Subsystem5/PWM_CB3/sub/generation'
//  '<S599>' : 'imperix_ctrl/Closed_loop_control/Subsystem7/Alpha-Beta-Zero to abc'
//  '<S600>' : 'imperix_ctrl/Closed_loop_control/Subsystem7/dq0 to Alpha-Beta-Zero'
//  '<S601>' : 'imperix_ctrl/Closed_loop_control/Subsystem7/dq0 to Alpha-Beta-Zero/Compare To Constant'
//  '<S602>' : 'imperix_ctrl/Closed_loop_control/Subsystem7/dq0 to Alpha-Beta-Zero/Compare To Constant1'
//  '<S603>' : 'imperix_ctrl/Closed_loop_control/Subsystem7/dq0 to Alpha-Beta-Zero/Subsystem - pi//2 delay'
//  '<S604>' : 'imperix_ctrl/Closed_loop_control/Subsystem7/dq0 to Alpha-Beta-Zero/Subsystem1'
//  '<S605>' : 'imperix_ctrl/Closed_loop_control/Subsystem8/Sample and Hold'
//  '<S606>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB'
//  '<S607>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB1'
//  '<S608>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB2'
//  '<S609>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB3'
//  '<S610>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB/sub'
//  '<S611>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB/sub/generation'
//  '<S612>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB1/sub'
//  '<S613>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB1/sub/generation'
//  '<S614>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB2/sub'
//  '<S615>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB2/sub/generation'
//  '<S616>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB3/sub'
//  '<S617>' : 'imperix_ctrl/Closed_loop_control/Subsystem9/PWM_CB3/sub/generation'
//  '<S618>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter1/sub'
//  '<S619>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter1/sub/generation'
//  '<S620>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter11/sub'
//  '<S621>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter11/sub/generation'
//  '<S622>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter16/sub'
//  '<S623>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter16/sub/generation'
//  '<S624>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter2/sub'
//  '<S625>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter2/sub/generation'
//  '<S626>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter3/sub'
//  '<S627>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter3/sub/generation'
//  '<S628>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter5/sub'
//  '<S629>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter5/sub/generation'
//  '<S630>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter6/sub'
//  '<S631>' : 'imperix_ctrl/Closed_loop_control/Tunable parameter6/sub/generation'
