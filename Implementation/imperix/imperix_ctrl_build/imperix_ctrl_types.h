...
#ifndef struct_cell_wrap_imperix_ctrl_T
#define struct_cell_wrap_imperix_ctrl_T

struct cell_wrap_imperix_ctrl_T
{
  uint32_T f1[8];
};

#endif                                 // struct_cell_wrap_imperix_ctrl_T
...
struct dsp_simulink_MovingAverage_im_T
{
  ...
  cell_wrap_imperix_ctrl_T inputVarSize;
  int32_T NumChannels;
  int32_T FrameLength;
  real_T pCumSum;
